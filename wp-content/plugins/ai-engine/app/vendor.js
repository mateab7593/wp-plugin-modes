 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(2673).A)("circle-check-big",[["path",{d:"M21.801 10A10 10 0 1 1 17 3.335",key:"yps3ct"}],["path",{d:"m9 11 3 3L22 4",key:"1pflzl"}]])},1602:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(2673).A)("circle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]])},6190:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
`,a=()=>({colors:o}),s=({children:e})=>React.createElement(React.Fragment,null,React.createElement(i,{key:"neko-ui-styles"}),e),l=({children:e})=>React.createElement(s,null,e)},9296:(e,t,n)=>{"use strict";n.d(t,{M:()=>f});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(2109),c=n(1329),u=n(6897);function d(){return d=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},d.apply(this,arguments)}const h=(0,s.Ay)((e=>{let{className:t="primary",variant:n,disabled:i=!1,icon:a=null,color:s=null,onClick:h=(()=>{}),onStopClick:p=null,rounded:f,isBusy:g=!1,busy:m=!1,spinning:y=!1,disabledColor:b=null,busyText:v,hideBusyIcon:x=!1,busyIconSize:k,requirePro:w=!1,isPro:_=!1,small:S,large:E,width:C,height:A,fullWidth:M,startTime:O=null,progress:R=null,ai:P=!1,children:T,...z}=e;const j=m||g;o().useEffect((()=>{g&&console.log('NekoButton: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[g]);const I=o().useRef(null),N=o().useRef(null),[$,L]=o().useState(null);o().useLayoutEffect((()=>{I.current&&!N.current&&(N.current=I.current.offsetWidth)})),o().useEffect((()=>{if(!j&&!p){const e=setTimeout((()=>{L(null)}),300);return()=>clearTimeout(e)}}),[j,p]),o().useEffect((()=>{t&&["primary","primary-block","secondary","danger","success","warning","header"].includes(t)&&!n&&console.warn(`NekoButton: Using 'className' prop for button variants is deprecated. Please use 'variant' prop instead. Found className="${t}"`)}),[t,n]);const D=n||(["primary","primary-block","secondary","danger","success","warning","header"].includes(t)?t:"primary"),F=t&&!["primary","primary-block","secondary","danger","success","warning","header"].includes(t)?t:"";o().useEffect((()=>{P&&(n||["secondary","danger","success","warning","header"].includes(D))&&console.warn('NekoButton: The "ai" property doesn\'t need a variant. The ai styling will override the variant styling.')}),[P,n,D]);const B=i||w&&!_,H=!!a,W=w&&!_,q=!!p&&j,U=(0,r.useMemo)((()=>{let e="number"==typeof C?C:30;return S&&(e*=.8),E&&(e*=1.3),"header"===D||t&&t.includes("header")?20:f?e-12:e-14}),[C,f,S,E,D,t]),[V,K]=(0,r.useState)(null);(0,u.$$)((()=>K(new Date)),O?1e3:null),(0,r.useEffect)((()=>{O||K(null)}),[O]);const Q=(0,r.useMemo)((()=>{if(!O||!V)return null;const e=Math.floor((V-O)/1e3),t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`}),[V,O]),Y=(0,u.gR)("neko-button",D,F,{"has-icon":H},{"custom-color":s},{small:S},{large:E},{rounded:f},{busy:j},{"is-pro":W},{full:M},{"has-stop":q},{ai:P});return o().createElement("button",d({ref:I,type:"button",className:Y,onClick:e=>{if(!j&&I.current){const e=p&&N.current?N.current:I.current.offsetWidth;L(e)}B||q||h(),e.stopPropagation(),e.preventDefault()},disabled:B&&!(j&&q),style:j&&$?{minWidth:`${$}px`,width:`${$}px`}:void 0},z),j&&null!==R&&R>0&&o().createElement("div",{className:"progress-bar",style:{width:`${R}%`}}),j&&!q&&!x&&o().createElement("div",{className:"busy-wrapper"},o().createElement("div",{className:"busy-icon"},o().createElement(l.z,{raw:!0,icon:"sync",width:16,height:16})),null!==R&&R>=0&&o().createElement("span",{className:"progress-percentage"},Math.round(R),"%"),Q&&o().createElement("span",{className:"chrono-time"},Q)),!j&&!q&&o().createElement("div",{className:"normal-content"},H&&!f&&!!T&&o().createElement("div",{className:"icon-section"},o().createElement(l.z,{raw:!0,icon:a,width:U,height:U,spinning:y,strokeWidth:f&&S?2.5:void 0})),H&&!f&&!T&&o().createElement(l.z,{raw:!0,icon:a,width:U,height:U,spinning:y,style:{margin:"0 auto"},strokeWidth:f&&S?2.5:void 0}),H&&f&&o().createElement(l.z,{raw:!0,icon:a,width:U,height:U,spinning:y,style:{margin:"0 auto"},strokeWidth:f&&S?2.5:void 0}),!!T&&o().createElement("span",{className:H&&!f?"button-text":""},T)),q&&o().createElement(o().Fragment,null,o().createElement("div",{className:"busy-icon"},o().createElement(l.z,{raw:!0,icon:"sync",width:16,height:16})),o().createElement("div",{className:"stop-section",onClick:e=>{e.stopPropagation(),p()}},o().createElement(l.z,{raw:!0,icon:"stop",width:"14",height:"14"}))),W&&o().createElement(c.K,{style:{marginLeft:"8px"}}))}))`
  position: relative;
  display: inline-flex;
  align-items: center;
...
`,p=({isCollapsed:e,onClick:t,border:n="left",direction:i="right",size:a=20,color:p,borderColor:f,title:g,className:m,style:y,...b})=>{const v=(0,r.useRef)(null),[x,k]=(0,r.useState)(!1);(0,r.useEffect)((()=>{if(v.current){const e=null!==v.current.closest(".primary");k(e)}}),[]);const w="right"===i?e?"Show Right Panel":"Hide Right Panel":e?"Show Left Panel":"Hide Left Panel";return o().createElement(h,d({ref:v,onClick:t,border:n,$isPrimary:x,title:g||w,className:m,style:{color:p||void 0,...y}},b),"right"===i?e?o().createElement(s,{size:a}):o().createElement(l,{size:a}):"left"===i?e?o().createElement(c,{size:a}):o().createElement(u,{size:a}):null)}},2557:(e,t,n)=>{"use strict";n.d(t,{A:()=>d});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(6897),l=n(2109);function c(){return c=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},c.apply(this,arguments)}const u=e=>{const{spinner:t=!0,busy:n=!1,isBusy:i=!1,overlayStyle:a,spinnerTop:u=!1}=e,d=n||i;o().useEffect((()=>{i&&console.log('NekoBusyOverlay: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[i]);const[h,p]=(0,r.useState)(!0);(0,r.useEffect)((()=>{let e;return d?p(!0):e=setTimeout((()=>{p(!1),e=null}),250),()=>{e&&clearTimeout(e)}}),[d]);const f=(0,s.gR)("neko-overlay",{overlayHidden:!d,spinnerTop:u}),g=h?o().createElement(o().Fragment,null,o().createElement("div",{className:f,style:a},Boolean(t)&&o().createElement("div",{className:"neko-busy-icon "+(d?"":"spinnerHidden")},o().createElement(l.z,{raw:!0,icon:"sync",width:32,height:32}))),o().createElement("style",{jsx:"true"},"\n        .neko-overlay {\n          position: absolute;\n          top: 0;\n          left: 0;\n          bottom: 0;\n          width: 100%;\n          height: 100%;\n          background: var(--neko-main-overlay-color);\n          border-radius: 8px;\n          transition: opacity 1s ease-out;\n          z-index: 10;\n          display: flex;\n          align-items: center;\n          flex-direction: column;\n          justify-content: center;\n          overflow: hidden;\n        }\n\n        .overlayHidden {\n          opacity: 0;\n          transition: opacity 0.25s ease-out;\n        }\n        .spinnerHidden {\n          opacity: 0;\n          transition: opacity 0.25s ease-out;\n        }\n        .spinnerTop {\n          justify-content: flex-start;\n          padding-top: 80px;\n        }\n        .neko-busy-icon {\n          position: relative;\n          display: flex;\n          justify-content: center;\n          align-items: center;\n          animation: spin 1s linear infinite;\n        }\n        .neko-busy-icon svg {\n          color: white;\n          transform: scaleY(-1);\n        }\n        @keyframes spin {\n          from {\n            transform: rotate(0deg);\n          }\n          to {\n            transform: rotate(360deg);\n          }\n        }\n      ")):null,m={...e,busy:void 0,spinner:void 0};return o().createElement("div",c({style:{position:"relative"}},m),g,e.children)};u.propTypes={busy:a().bool,isBusy:a().bool,spinner:a().bool,spinnerTop:a().bool,children:a().oneOfType([a().arrayOf(a().node),a().node]).isRequired};const d=u},2155:(e,t,n)=>{"use strict";n.d(t,{hS:()=>$e,Ay:()=>Le,ho:()=>Ne});var r=n(2673);
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const x=(0,r.A)("rotate-ccw",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]]),k=(0,r.A)("check",[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]]);var w=n(7192),_=n(1602),S=n(8785),E=n(7843);
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const C=(0,r.A)("trash-2",[["path",{d:"M10 11v6",key:"nco0om"}],["path",{d:"M14 11v6",key:"outv1u"}],["path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6",key:"miytrc"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2",key:"e791ji"}]]),A=(0,r.A)("undo",[["path",{d:"M3 7v6h6",key:"1v2h90"}],["path",{d:"M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13",key:"1r6uu6"}]]);var M=n(2973),O=n(5577);
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const R=(0,r.A)("database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]]),P=(0,r.A)("wrench",[["path",{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z",key:"1ngwbx"}]]),T=(0,r.A)("settings",[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915",key:"1i5ecw"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);var z=n(812);
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const j=(0,r.A)("cat",[["path",{d:"M12 5c.67 0 1.35.09 2 .26 1.78-2 5.03-2.84 6.42-2.26 1.4.58-.42 7-.42 7 .57 1.07 1 2.24 1 3.44C21 17.9 16.97 21 12 21s-9-3-9-7.56c0-1.25.5-2.4 1-3.44 0 0-1.89-6.42-.5-7 1.39-.58 4.72.23 6.5 2.23A9.04 9.04 0 0 1 12 5Z",key:"x6xyqk"}],["path",{d:"M8 14v.5",key:"1nzgdb"}],["path",{d:"M16 14v.5",key:"1lajdz"}],["path",{d:"M11.25 16.25h1.5L12 17l-.75-.75Z",key:"12kq1m"}]]),I=(0,r.A)("circle-arrow-up",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m16 12-4-4-4 4",key:"177agl"}],["path",{d:"M12 16V8",key:"1sbj14"}]]),N=(0,r.A)("pencil",[["path",{d:"M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z",key:"1a8usu"}],["path",{d:"m15 5 4 4",key:"1mk7zo"}]]),$=(0,r.A)("layout-dashboard",[["rect",{width:"7",height:"9",x:"3",y:"3",rx:"1",key:"10lvy0"}],["rect",{width:"7",height:"5",x:"14",y:"3",rx:"1",key:"16une8"}],["rect",{width:"7",height:"9",x:"14",y:"12",rx:"1",key:"1hutg5"}],["rect",{width:"7",height:"5",x:"3",y:"16",rx:"1",key:"ldoo1y"}]]),L=(0,r.A)("search",[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]]),D=(0,r.A)("folder",[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]),F=(0,r.A)("folder-open",[["path",{d:"m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2",key:"usdka0"}]]),B=(0,r.A)("image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]),H=(0,r.A)("images",[["path",{d:"m22 11-1.296-1.296a2.4 2.4 0 0 0-3.408 0L11 16",key:"9kzy35"}],["path",{d:"M4 8a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2",key:"1t0f0t"}],["circle",{cx:"13",cy:"7",r:"1",fill:"currentColor",key:"1obus6"}],["rect",{x:"8",y:"2",width:"14",height:"14",rx:"2",key:"1gvhby"}]]),W=(0,r.A)("plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]),q=(0,r.A)("folder-plus",[["path",{d:"M12 10v6",key:"1bos4e"}],["path",{d:"M9 13h6",key:"1uhe8q"}],["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]),U=(0,r.A)("image-plus",[["path",{d:"M16 5h6",key:"1vod17"}],["path",{d:"M19 2v6",key:"4bpg5p"}],["path",{d:"M21 11.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7.5",key:"1ue2ih"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}]]),V=(0,r.A)("grid-3x3",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}],["path",{d:"M3 9h18",key:"1pudct"}],["path",{d:"M3 15h18",key:"5xshup"}],["path",{d:"M9 3v18",key:"fh3hqa"}],["path",{d:"M15 3v18",key:"14nvp0"}]]),K=(0,r.A)("twitter",[["path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z",key:"pff0z6"}]]),Q=(0,r.A)("instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]),Y=(0,r.A)("facebook",[["path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z",key:"1jg4f8"}]]);var G=n(1666);
/**
 * @license lucide-react v0.542.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const me=(0,r.A)("file-plus",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M9 15h6",key:"cctwl0"}],["path",{d:"M12 18v-6",key:"17g6i2"}]]),ye=(0,r.A)("save",[["path",{d:"M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z",key:"1c8476"}],["path",{d:"M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7",key:"1ydtos"}],["path",{d:"M7 3v4a1 1 0 0 0 1 1h7",key:"t51u73"}]]),be=(0,r.A)("rotate-cw",[["path",{d:"M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8",key:"1p45f6"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}]]),ve=(0,r.A)("square-pen",[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z",key:"ohrbg2"}]]),xe=(0,r.A)("refresh-ccw",[["path",{d:"M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"14sxne"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16",key:"1hlbsb"}],["path",{d:"M16 16h5v5",key:"ccwih5"}]]),ke=(0,r.A)("zap",[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z",key:"1xq2db"}]]),we=(0,r.A)("file-up",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M12 12v6",key:"3ahymv"}],["path",{d:"m15 15-3-3-3 3",key:"15xj92"}]]),_e=(0,r.A)("sparkles",[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]]),Se=(0,r.A)("bug",[["path",{d:"m8 2 1.88 1.88",key:"fmnt4t"}],["path",{d:"M14.12 3.88 16 2",key:"qol33r"}],["path",{d:"M9 7.13v-1a3.003 3.003 0 1 1 6 0v1",key:"d7y7pr"}],["path",{d:"M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6",key:"xs1cw7"}],["path",{d:"M12 20v-9",key:"1qisl0"}],["path",{d:"M6.53 9C4.6 8.8 3 7.1 3 5",key:"32zzws"}],["path",{d:"M6 13H2",key:"82j7cp"}],["path",{d:"M3 21c0-2.1 1.7-3.9 3.8-4",key:"4p0ekp"}],["path",{d:"M20.97 5c0 2.1-1.6 3.8-3.5 4",key:"18gb23"}],["path",{d:"M22 13h-4",key:"1jl80f"}],["path",{d:"M17.2 17c2.1.1 3.8 1.9 3.8 4",key:"k3fwyw"}]]),Ee=(0,r.A)("scan-eye",[["path",{d:"M3 7V5a2 2 0 0 1 2-2h2",key:"aa7l1z"}],["path",{d:"M17 3h2a2 2 0 0 1 2 2v2",key:"4qcy5o"}],["path",{d:"M21 17v2a2 2 0 0 1-2 2h-2",key:"6vwrx8"}],["path",{d:"M7 21H5a2 2 0 0 1-2-2v-2",key:"ioqczr"}],["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}],["path",{d:"M18.944 12.33a1 1 0 0 0 0-.66 7.5 7.5 0 0 0-13.888 0 1 1 0 0 0 0 .66 7.5 7.5 0 0 0 13.888 0",key:"11ak4c"}]]),Ce=(0,r.A)("feather",[["path",{d:"M12.67 19a2 2 0 0 0 1.416-.588l6.154-6.172a6 6 0 0 0-8.49-8.49L5.586 9.914A2 2 0 0 0 5 11.328V18a1 1 0 0 0 1 1z",key:"18jl4k"}],["path",{d:"M16 8 2 22",key:"vp34q"}],["path",{d:"M17.5 15H9",key:"1oz8nu"}]]),Ae=(0,r.A)("external-link",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]),Me=(0,r.A)("download",[["path",{d:"M12 15V3",key:"m9g1x1"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["path",{d:"m7 10 5 5 5-5",key:"brsn70"}]]),Oe=(0,r.A)("share-2",[["circle",{cx:"18",cy:"5",r:"3",key:"gq8acd"}],["circle",{cx:"6",cy:"12",r:"3",key:"w7nqdw"}],["circle",{cx:"18",cy:"19",r:"3",key:"1xt0gg"}],["line",{x1:"8.59",x2:"15.42",y1:"13.51",y2:"17.49",key:"47mynk"}],["line",{x1:"15.41",x2:"8.59",y1:"6.51",y2:"10.49",key:"1n3mei"}]]),Re=(0,r.A)("mail",[["path",{d:"m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7",key:"132q7q"}],["rect",{x:"2",y:"4",width:"20",height:"16",rx:"2",key:"izxlao"}]]),Pe=(0,r.A)("phone",[["path",{d:"M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384",key:"9njp5v"}]]),Te=(0,r.A)("message-circle",[["path",{d:"M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719",key:"1sd12s"}]]),ze=(0,r.A)("bell",[["path",{d:"M10.268 21a2 2 0 0 0 3.464 0",key:"vwvbt9"}],["path",{d:"M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326",key:"11g9vi"}]]),je=(0,r.A)("house",[["path",{d:"M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8",key:"5wwlr5"}],["path",{d:"M3 10a2 2 0 0 1 .709-1.528l7-5.999a2 2 0 0 1 2.582 0l7 5.999A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z",key:"1d0kgt"}]]),Ie={"timer-reset":o,tag:i,"format-list-bulleted":a,duplicate:s,lock:l,"lock-open":c,"file-undo":u,"file-move":d,"chevron-double-left":h.A,"chevron-double-right":p.A,"chevron-left":f.A,"chevron-right":g.A,"chevron-down":m.A,"chevron-up":y.A,pause:b.A,play:v.A,replay:x,check:k,"check-circle":w.A,circle:_.A,stop:S.A,"checkbox-blank":S.A,"checkbox-marked":E.A,delete:C,undo:A,alert:M.A,warning:O.A,database:R,tools:P,cog:T,close:z.A,cat:j,upload:I,trash:C,pencil:N,dashboard:$,search:L,folder:D,"folder-open":F,image:B,"image-multiple-outline":H,plus:W,"folder-plus":q,"image-plus":U,"view-grid":V,list:a,twitter:K,instagram:Q,facebook:Y,star:G.A,"timer-outline":X,link:Z,linkedin:J,pinterest:ee,"zoom-in":te,"info-outline":ne.A,"image-off-outline":re,"arrow-up":oe,"arrow-down":ie,sort:ae,eye:se,"eye-off":le,"rocket-launch":ce,"calendar-month":ue,wand:de,mastodon:he,filter:pe,question:fe,loading:ge.A,new:me,save:ye,reset:be,rename:ve,edit:ve,sync:xe,lightning:ke,zap:ke,refresh:xe,"file-upload":we,sparkles:_e,debug:Se,retina:Ee,feather:Ce,"external-link":Ae,download:Me,share:Oe,mail:Re,phone:Pe,message:Te,bell:ze,home:je},Ne={trash:"rgb(255 255 255 / 25%)",delete:"rgb(255 255 255 / 25%)",pencil:"rgb(255 255 255 / 25%)",filter:"rgb(255 255 255 / 25%)",lightning:"rgb(255 255 255 / 25%)",zap:"rgb(255 255 255 / 25%)",stop:"rgb(255 255 255 / 25%)","checkbox-blank":"rgb(255 255 255 / 25%)","checkbox-marked":"rgb(255 255 255 / 25%)",star:"rgb(255 255 255 / 25%)","file-upload":"rgb(255 255 255 / 25%)",cat:"rgb(255 255 255 / 25%)",pinterest:"rgb(255 255 255 / 25%)",instagram:"rgb(255 255 255 / 25%)",facebook:"rgb(255 255 255 / 25%)","rocket-launch":"rgb(255 255 255 / 25%)",upload:"rgb(255 255 255 / 25%)","zoom-in":"rgb(255 255 255 / 25%)",dashboard:"rgb(255 255 255 / 25%)",tools:"rgb(255 255 255 / 25%)",cog:"rgb(255 255 255 / 25%)",database:"rgb(255 255 255 / 25%)",folder:"rgb(255 255 255 / 25%)","lock-open":"rgb(255 255 255 / 25%)",lock:"rgb(255 255 255 / 25%)",question:"rgb(255 255 255 / 25%)","info-outline":"rgb(255 255 255 / 25%)",alert:"rgb(255 255 255 / 25%)",play:"rgb(255 255 255 / 25%)",sparkles:"rgb(255 255 255 / 25%)",bell:"rgb(255 255 255 / 25%)",home:"rgb(255 255 255 / 25%)",phone:"rgb(255 255 255 / 25%)",message:"rgb(255 255 255 / 25%)"},$e={chevron:18,buttonRounded:18,buttonNormal:24,default:30},Le=Ie},5263:(e,t,n)=>{"use strict";n.d(t,{R:()=>p});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(1329),c=n(6087),u=n(6897);function d(){return d=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},d.apply(this,arguments)}const h=s.Ay.div`
  user-select: none;
...
`,p=e=>{const{name:t,checked:n=!1,indeterminate:r=!1,onChange:i,label:a,description:s,isPro:p=!1,disabled:f,requirePro:g=!1,isBusy:m=!1,busy:y=!1,small:b=!1,color:v,variant:x,...k}=e,w=y||m;o().useEffect((()=>{m&&console.log('NekoCheckbox: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[m]);const _=g&&!p,S=f||_,E=(0,u.gR)("neko-checkbox",e.className,{disabled:S},{small:b}),C=(0,u.gR)("neko-checkbox",{disabled:S,"neko-checked":n,"neko-indeterminate":r,small:b}),A=(0,u.gR)("neko-checked-mark"),M=(0,u.gR)("neko-indeterminate-mark");return o().createElement(h,d({className:E,checked:n,disabled:S,color:v,variant:x,onClick:e=>e.stopPropagation()},k),o().createElement("div",{className:"neko-checkbox-container"},o().createElement("div",{className:"neko-content",onClick:r=>{S||(i?i(!n,t,r):console.log("The onChange handler is not set for the NekoCheckbox.",e))}},o().createElement("div",{className:"neko-checkbox-check-container"},w&&o().createElement("div",{className:"neko-checkbox-busy-container"},o().createElement("div",{className:C},o().createElement(c.X,{type:"circle",size:"16px"}))),!w&&o().createElement(o().Fragment,null,o().createElement("div",{className:C},o().createElement("div",{className:A}),o().createElement("div",{className:M})))),(a||_||s)&&o().createElement("div",{className:"neko-checkbox-inner-container"},o().createElement("span",{className:"neko-label-container"},o().createElement("span",{className:"neko-label"},a),o().createElement(l.K,{className:"inline",show:_,style:{position:"relative",top:-1}})),s?"string"==typeof s?o().createElement("small",{className:"description",dangerouslySetInnerHTML:{__html:s}}):o().createElement("small",{className:"description"},s):null))))};p.propTypes={name:a().string,checked:a().bool,label:a().string,description:a().string,isPro:a().bool,requirePro:a().bool,busy:a().bool,isBusy:a().bool,small:a().bool,color:a().oneOf(["blue","purple","green","red","orange","yellow","gray"]),variant:a().oneOf(["danger"])}},4536:(e,t,n)=>{"use strict";n.d(t,{E:()=>l});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i);const s=(0,n(3185).Ay)((e=>{const{name:t,max:n=-1,isPro:r=!1}=e,i=o().Children.map(e.children,(e=>e.props.name?e:o().cloneElement(e,{name:t,isPro:r})));return o().createElement("div",{className:"neko-checkbox-group"},i)}))`
...
`,u=e=>{if(!e||""===e)return{h:0,s:0,v:0,a:100};3===(e=e.replace("#","")).length&&(e=e.split("").map((e=>e+e)).join(""));const t=parseInt(e.slice(0,2),16)/255||0,n=parseInt(e.slice(2,4),16)/255||0,r=parseInt(e.slice(4,6),16)/255||0,o=e.length>=8?parseInt(e.slice(6,8),16)/255:1,i=Math.max(t,n,r),a=Math.min(t,n,r),s=i-a;let l=0;const c=0===i?0:s/i,u=i;if(i!==a)switch(i){case t:l=((n-r)/s+(n<r?6:0))/6;break;case n:l=((r-t)/s+2)/6;break;case r:l=((t-n)/s+4)/6}return{h:360*l,s:100*c,v:100*u,a:100*o}},d=(e,t,n,r=100,o=null)=>{e/=360,t/=100,n/=100;const i=r/100,a=Math.floor(6*e),s=6*e-a,l=n*(1-t),c=n*(1-s*t),u=n*(1-(1-s)*t);let d,h,p;switch(a%6){case 0:d=n,h=u,p=l;break;case 1:d=c,h=n,p=l;break;case 2:d=l,h=n,p=u;break;case 3:d=l,h=c,p=n;break;case 4:d=u,h=l,p=n;break;case 5:d=n,h=l,p=c;break;default:d=0,h=0,p=0}const f=e=>{const t=Math.round(255*e).toString(16);return 1===t.length?"0"+t:t},g=(null!==o?o:i<.999)?f(i):"";return`#${f(d)}${f(h)}${f(p)}${g}`},h=({name:e,value:t="#000000",onChange:n,supportAlpha:i=!0,disabled:a=!1})=>{const s=(0,r.useRef)(),h=(0,r.useRef)(),p=(0,r.useRef)(),f=(0,r.useRef)(),g=(0,r.useRef)(),[m,y]=(0,r.useState)(!1),[b,v]=(0,r.useState)(t),[x,k]=(0,r.useState)((()=>{const e=u(t);return i||(e.a=100),e})),[w,_]=(0,r.useState)(!1),[S,E]=(0,r.useState)(!1),[C,A]=(0,r.useState)(!1),[M,O]=(0,r.useState)({top:0,left:0});(0,r.useEffect)((()=>{v(t);const e=u(t);i||(e.a=100),k(e)}),[t,i]);const R=(0,r.useCallback)((()=>{b!==t&&n(b,e),y(!1)}),[b,t,n,e]);var P,T;P=s,T=R,(0,r.useEffect)((()=>{let e=!1,t=!1;const n=n=>{!e&&t&&P.current&&!P.current.contains(n.target)&&T(n)},r=n=>{t=P.current,e=P.current&&P.current.contains(n.target)};return document.addEventListener("mousedown",r),document.addEventListener("touchstart",r),document.addEventListener("click",n),()=>{document.removeEventListener("mousedown",r),document.removeEventListener("touchstart",r),document.removeEventListener("click",n)}}),[P,T]),(0,r.useEffect)((()=>{if(m&&h.current&&s.current){const e=h.current.getBoundingClientRect(),t=224,n=i?285:260;let r=e.top-n-8,o=e.left+e.width/2-t/2;r<10&&(r=e.bottom+8),o<10&&(o=10),o+t>window.innerWidth-10&&(o=window.innerWidth-t-10),r>e.bottom&&r+n>window.innerHeight-10&&(r=e.top-n-8),O({top:r,left:o})}}),[m,i]);const z=e=>{k(e);const t=d(e.h,e.s,e.v,e.a,!!i&&null);v(t)},j=e=>{if(!p.current)return;const t=p.current.getBoundingClientRect(),n=Math.max(0,Math.min(1,(e.clientX-t.left)/t.width)),r=Math.max(0,Math.min(1,(e.clientY-t.top)/t.height)),o={h:x.h,s:100*n,v:100*(1-r),a:x.a};z(o)},I=e=>{if(!f.current)return;const t=f.current.getBoundingClientRect(),n={h:360*Math.max(0,Math.min(1,(e.clientX-t.left)/t.width)),s:x.s,v:x.v,a:x.a};z(n)},N=e=>{if(!g.current)return;const t=g.current.getBoundingClientRect(),n=Math.max(0,Math.min(1,(e.clientX-t.left)/t.width)),r={h:x.h,s:x.s,v:x.v,a:100*n};z(r)};(0,r.useEffect)((()=>{const e=e=>{w?j(e):S?I(e):C&&N(e)},t=()=>{_(!1),E(!1),A(!1)};return(w||S||C)&&(document.addEventListener("mousemove",e),document.addEventListener("mouseup",t)),()=>{document.removeEventListener("mousemove",e),document.removeEventListener("mouseup",t)}}),[w,S,C,x]);const $=d(x.h,100,100,100),L=d(x.h,x.s,x.v,100);return o().createElement(c,{className:"neko-color-picker "+(a?"disabled":"")},o().createElement("div",{className:"swatch",ref:h,onClick:()=>!a&&y(!0)},o().createElement("div",{style:{backgroundColor:a?"var(--neko-gray-80)":b,position:"absolute",top:0,left:0,right:0,bottom:0}})),m&&o().createElement("div",{className:"popover",ref:s,style:{top:`${M.top}px`,left:`${M.left}px`}},o().createElement("div",{className:"color-picker-area",ref:p,style:{backgroundColor:$},onMouseDown:e=>{_(!0),j(e)}},o().createElement("div",{className:"color-picker-cursor",style:{left:`${x.s}%`,top:100-x.v+"%",backgroundColor:L}})),o().createElement("div",{className:"hue-slider",ref:f,onMouseDown:e=>{E(!0),I(e)}},o().createElement("div",{className:"hue-cursor",style:{left:x.h/360*100+"%",backgroundColor:$}})),i&&o().createElement("div",{className:"alpha-slider",ref:g,style:{"--current-color":L},onMouseDown:e=>{A(!0),N(e)}},o().createElement("div",{className:"alpha-cursor",style:{left:`${x.a}%`,backgroundColor:b}})),o().createElement("input",{type:"text",className:"hex-input",value:b,onChange:e=>{const t=e.target.value,n=i?9:7;if(/^#[0-9A-Fa-f]{0,8}$/.test(t)&&t.length<=n&&(v(t),7===t.length||i&&9===t.length)){const e=u(t);i||(e.a=100),k(e)}},maxLength:i?9:7,placeholder:i?"#RRGGBBAA":"#RRGGBB"}),o().createElement("div",{style:{display:"flex",padding:0}},o().createElement(l.M,{style:{flex:1},onClick:()=>n(b,e)},"Apply"))))};h.propTypes={name:a().string,value:a().string,onChange:a().func.isRequired,supportAlpha:a().bool,disabled:a().bool}},8696:(e,t,n)=>{"use strict";n.d(t,{A:()=>f});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(2109),c=n(6897);function u(){return u=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},u.apply(this,arguments)}const d=e=>e.split(",").map((e=>e.trim())).filter((e=>e.length>0)),h=(e,t)=>{const{type:n="text",name:i,value:a="",description:s,placeholder:h="",onChange:p,onEnter:f,onBlur:g,onFinalChange:m,readOnly:y=!1,step:b=1,min:v=0,max:x=null,maxLength:k,natural:w=!1,onReset:_,isCommaSeparatedArray:S=!1,iconEmpty:E="",iconFilled:C="",onEmptyIconClick:A,onFilledIconClick:M,className:O,style:R,inputStyle:P,...T}=e,[z,j]=(0,r.useState)(a||0===a?a:""),I=!!p,N=k||("number"===n?3:void 0);(0,r.useEffect)((()=>{m&&(f||g)&&console.warn("NekoInput: Since onFinalChange is used, onEnter and onBlur are redundant.")}),[m,f,g]),(0,r.useEffect)((()=>{var e;I||j(S?(e=a,Array.isArray(e)||(console.warn("The provided value is not an array. Falling back to an empty array."),e=[]),e.join(", ")):a)}),[a]);const $=e=>{const t=e.target.value,n=S?d(t):t;e.stopPropagation(),e.preventDefault(),I?p(n,i):j(t)},L=e=>{if("Enter"===e.key){e.preventDefault();const t=e.target.value,n=S?d(t):t;m?m(n,i):f&&f(n,i)}},D=e=>{const t=e.target.value,n=S?d(t):t;(S?((e,t)=>{if(!Array.isArray(e)||!Array.isArray(t)||e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0})(a,n):a===n)||(m?m(n,i):g&&g(n,i))},F=(0,c.gR)("neko-input",{natural:w}),B=()=>{const e=I?a:z;return S?!!Array.isArray(e)&&e.length>0:e&&""!==e&&0!==e},H=E||C,W=Boolean(B()&&C),q=Boolean(!B()&&E);return o().createElement("div",{className:O,style:R},o().createElement("div",{style:{position:"relative"}},"number"===n?o().createElement("input",u({ref:t,className:F,name:i,value:I?a:z,type:n,disabled:y,step:b,min:v,max:x,maxLength:N,autoComplete:"off","data-form-type":"other",placeholder:h,style:{...P,paddingRight:H?"30px":void 0},onChange:$,onKeyPress:L,onBlur:e=>{(e=>{const t=Number(e.target.value);v&&t<Number(v)?e.target.value=v:x&&t>Number(x)&&(e.target.value=x)})(e),D(e)},readOnly:y},T)):o().createElement("input",u({ref:t,className:F},T,{name:i,value:I?a:z,type:n,disabled:y,spellCheck:"false",autoComplete:"off","data-form-type":"other",placeholder:h,style:{...P,paddingRight:H?"30px":void 0},maxLength:N,onChange:$,onKeyPress:L,onBlur:D,readOnly:y},T)),!!a&&!!_&&o().createElement(l.z,{icon:"close",width:24,style:{position:"absolute",top:"3px",right:"3px"},variant:"blue",onClick:()=>_()}),q&&o().createElement(l.z,{icon:E,width:15,style:{position:"absolute",top:"50%",right:"8px",transform:"translateY(-50%)",pointerEvents:A?"auto":"none",cursor:A?"pointer":"default"},color:"#5a5a5a82",onClick:A}),W&&o().createElement(l.z,{icon:C,width:15,style:{position:"absolute",top:"50%",right:"8px",transform:"translateY(-50%)",pointerEvents:M?"auto":"none",cursor:M?"pointer":"default"},color:"var(--neko-blue)",onClick:M})),s&&("string"==typeof s?o().createElement("p",{className:"neko-input-description",dangerouslySetInnerHTML:{__html:s}}):o().createElement("p",{className:"neko-input-description"},s)))},p=(0,s.Ay)((0,r.forwardRef)(h))`
  .neko-input {
    font-family: var(--neko-font-family);
    font-size: var(--neko-font-size);
    border: 1.5px solid var(--neko-input-border);
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const f=(0,n(2673).A)("circle-dot",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}]]);var g=n(1602),m=n(2109),y=n(8696),b=n(374),v=n(3185);const x=v.Ay.div`
  position: relative;
  border-radius: 8px;
  user-select: none;
  cursor: pointer;
...
`;function A(){return A=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},A.apply(this,arguments)}const M=e=>{const{name:t,description:n,scrolldown:i=!1,isPro:a=!1,onChange:h,isBusy:p=!1,busy:f=!1,chevronIconSize:g=u.hS.chevron,textFiltering:v,value:E,className:C,disabled:M,requirePro:O,multiple:R=!1,placeholder:P,...T}=e,z=f||p;o().useEffect((()=>{p&&console.log('NekoSelect: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[p]);let j,I,N,$,L=15;if(R){const t=o().Children.toArray(e.children).filter((e=>(E||[]).includes(e.props.value)||e.props.checked)).map((e=>e.props));j=t.map((e=>e.label)).join(", ")||P||"Select",I=n,N=t.some((e=>e.requirePro))||O,$=null}else{var D;const t=null===(D=o().Children.toArray(e.children).find((e=>e.props.value===E||e.props.checked)))||void 0===D?void 0:D.props;j=(null==t?void 0:t.label)||P||"Select",I=(null==t?void 0:t.description)||n,N=(null==t?void 0:t.requirePro)||O,$=null==t?void 0:t.icon,L=(null==t?void 0:t.iconSize)||15}const[F,B]=(0,r.useState)(!1),[H,W]=(0,r.useState)(""),q=(0,r.useRef)(),U=N&&!a;(0,r.useEffect)((()=>{R&&!i&&console.warn('NekoSelect: The "multiple" prop should be used with "scrolldown={true}" for proper functionality. Multiple selection requires the dropdown interface to work correctly.')}),[R,i]);(0,r.useEffect)((()=>{const e=e=>{"Escape"===e.key&&F&&B(!1)};if(F)return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}}),[F]);const V=o().Children.map(e.children,(n=>n?o().cloneElement(n,{name:n.props.name||t,checked:R?(E||[]).includes(n.props.value)||n.props.checked:n.props.value===E||n.props.checked,onClick:r=>((n,r)=>{if(n.stopPropagation(),h)if(R){let e=Array.isArray(E)?[...E]:[];e.includes(r)?e=e.filter((e=>e!==r)):e.push(r),h(e,t)}else r!==E&&h(r,t),i&&B(!1);else console.log("The onChange handler is not set for this select.",e)})(r,n.props.value),scrolldown:i,isPro:a,disabled:M,multiple:R}):null)),K=(0,r.useMemo)((()=>{if(!H||!V.length)return V;const e=H.toLowerCase().split(" ").filter((e=>e.length>0));return o().Children.toArray(V).filter((t=>{const n=`${"string"==typeof t.props.label?t.props.label.toLowerCase():""} ${"string"==typeof t.props.value?t.props.value.toLowerCase():""}`;return e.every((e=>n.includes(e)))}))}),[V,H]),Q=(0,l.gR)("neko-select",C,{"show-options":F,disabled:M||p}),Y=(0,l.gR)("neko-select-options",{hidden:!F}),G=(0,l.gR)("neko-select-option",{isBusy:z});return i?o().createElement(x,A({name:t},T,{onClick:()=>{M||p||B(!F)},className:Q,"data-is-disabled":M||p,ref:q}),o().createElement(k,{className:G},z?o().createElement(o().Fragment,null,o().createElement(c.X,{type:"circle",size:"20px"})):o().createElement(o().Fragment,null,$&&o().createElement(m.z,{icon:$,width:L,height:L,style:{marginRight:`${Math.max(L-15,4)}px`}}),o().createElement("span",{className:"neko-select-option-label"},j),o().createElement("div",{className:"rightContent"},U&&o().createElement(s.K,null),o().createElement("span",{className:"neko-chevron-wrap"},o().createElement(d.A,{size:g,className:"neko-select-chevron",style:{transform:F?"rotate(180deg)":"rotate(0deg)",transition:"transform 180ms cubic-bezier(0.2, 0.8, 0.2, 1)"}}))))),I&&("string"==typeof I?o().createElement(w,{dangerouslySetInnerHTML:{__html:I}}):o().createElement(w,null,I)),o().createElement(b.G,{visible:F,targetRef:q,onClose:()=>{F&&B(!1)}},o().createElement(_,{className:Y},v&&o().createElement(S,{className:"neko-select-filter-container"},o().createElement(y.A,{value:H,placeholder:"Search...",onChange:e=>W(e),onClick:e=>e.stopPropagation(),style:{background:"var(--neko-white)",borderRadius:10,margin:"5px 7px",borderColor:"var(--neko-input-background)"},inputStyle:{margin:0,borderRadius:0},autoFocus:!0})),o().createElement(S,null,K)))):V},O=e=>{const{id:t,name:n,value:r,checked:i=!1,label:a,description:c,onClick:u,scrolldown:d=!1,isPro:y=!1,optionDisabled:b=!1,requirePro:v=!1,icon:x,iconSize:k=20,multiple:_=!1}=e,S=v&&!y,A=(0,l.gR)({"neko-radio":!d},{"neko-select-option":d},e.className,{disabled:S||b}),M=_?i?h.A:p.A:i?f:g.A,O=o().createElement(C,{className:A,onClick:e=>{u(e,r)}},o().createElement("div",{className:"option"},o().createElement("div",{className:"option-group"},_?o().createElement(M,{size:k,color:S?"var(--neko-disabled-color)":i?"var(--neko-main-color)":"var(--neko-input-border)",style:{marginRight:"8px"}}):o().createElement("div",{style:{position:"relative",width:k,height:k,flexShrink:0,marginRight:"8px"}},o().createElement(g.A,{size:k,color:S?"var(--neko-disabled-color)":"var(--neko-input-border)",strokeWidth:1.5}),i&&o().createElement("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:.4*k,height:.4*k,borderRadius:"50%",backgroundColor:S?"var(--neko-disabled-color)":"var(--neko-main-color)"}})),x&&o().createElement(m.z,{icon:x,width:k,height:k,style:{marginRight:`${Math.max(k-11,4)}px`}}),a),o().createElement(s.K,{show:S}))),R=o().createElement(E,{className:A,onClick:e=>{u(e,r)}},o().createElement("label",{htmlFor:t},o().createElement("div",{style:{position:"relative",width:24,height:24,flexShrink:0}},o().createElement(g.A,{size:24,color:S?"var(--neko-disabled-color)":"var(--neko-input-border)",strokeWidth:1.5}),i&&o().createElement("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:10,height:10,borderRadius:"50%",backgroundColor:S?"var(--neko-disabled-color)":"var(--neko-main-color)"}})),o().createElement("div",{className:"inner-container"},o().createElement("span",{className:"label"},a,o().createElement(s.K,{className:"inline",style:{top:-1},show:S})),c&&("string"==typeof c?o().createElement(w,{style:{marginTop:0},dangerouslySetInnerHTML:{__html:c}}):o().createElement(w,{style:{marginTop:0}},c)))));return d?O:R},R=e=>o().createElement(M,e);R.propTypes={name:a().string,description:a().string,scrolldown:a().bool,isPro:a().bool,onChange:a().func,busy:a().bool,isBusy:a().bool,chevronIconSize:a().number,textFiltering:a().bool,multiple:a().bool,placeholder:a().string};const P=e=>o().createElement(O,e);P.propTypes={id:a().string,name:a().string,value:a().string,checked:a().bool,label:a().string,description:a().string,onClick:a().func,scrolldown:a().bool,isPro:a().bool,optionDisabled:a().bool,requirePro:a().bool,icon:a().string,iconSize:a().number,multiple:a().bool}},8051:(e,t,n)=>{"use strict";n.d(t,{$:()=>v});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185);const l=s.Ay.div`
  position: relative;
  user-select: none;
  padding-top: 24px;
  transition: opacity 0.3s ease;
...
`,d=e=>{let{width:t,height:n=24,fontSize:o="13px",onLabel:i="Yes",offLabel:a="No",onBackgroundColor:c="var(--neko-success)",offBackgroundColor:d="var(--neko-disabled-color)",onValue:h,offValue:p,small:f,checked:g=!1,onChange:m,disabled:y=!1,...b}=e;const v=(0,s.gR)("neko-switch",{small:f,"neko-checked":g}),x=(0,r.useCallback)((e=>{if(y)return;m(e?void 0===h||h:void 0!==p&&p)}),[h,p,m,y]);f&&(n=20,o="11px");const k=t||(i&&""!==i||a&&""!==a?70:40);return React.createElement(u,l({className:v,width:k,height:n,fontSize:o},b,{$offBackgroundColor:d,$onBackgroundColor:c,$onLabel:i,$offLabel:a,"data-is-disabled":y?"disabled":""}),React.createElement("span",{className:"neko-slider",onClick:()=>x(!g)}))};d.propTypes={width:i().number,height:i().number,fontSize:i().string,onValue:i().string,offValue:i().string,checked:i().bool,onBackgroundColor:i().string,offBackgroundColor:i().string,onLabel:i().string,offLabel:i().string}},3896:(e,t,n)=>{"use strict";n.d(t,{m:()=>h});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(6897),c=n(2109);function u(){return u=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},u.apply(this,arguments)}const d=(0,s.Ay)((e=>{const{name:t,value:n="",rows:i=6,description:a,placeholder:s="",onEnter:d=null,onBlurForce:h=!1,readOnly:p=!1,avoidOnEnterWithShift:f=!1,fullHeight:g=!1,maxLength:m=null,className:y,style:b,textAreaStyle:v={},countable:x=!1,disabled:k,tabToSpaces:w,copyable:_=!1,...S}=e,[E,C]=(0,r.useState)(n),[A,M]=(0,r.useState)(0),[O,R]=(0,r.useState)(!1),[P,T]=(0,r.useState)(!1),z=!!e.onChange,j=(0,r.useRef)(null),I=(0,r.useCallback)((e=>{if(w&&"Tab"===e.key){e.preventDefault();const t=j.current.selectionStart,n=j.current.selectionEnd,r=j.current.value;j.current.value=r.substring(0,t)+"  "+r.substring(n),j.current.selectionStart=j.current.selectionEnd=t+2}else R(e.shiftKey)}),[w]),N=(0,r.useCallback)((()=>{R(!1)}),[]);(0,r.useEffect)((()=>{const e=j.current;if(e)return e.addEventListener("keydown",I,!1),e.addEventListener("keyup",N,!1),()=>{e.removeEventListener("keydown",I,!1),e.removeEventListener("keyup",N,!1)}}),[I,N]),(0,r.useEffect)((()=>{if(z||C(n),"words"===x){const e=n.split(" ").filter((e=>""!==e)).length;M(e)}else x&&M(n.length)}),[n,x,z]);const $=(0,r.useCallback)((n=>{const r=m?n.target.value.substr(0,m):n.target.value;n.stopPropagation(),z?e.onChange(r,t):C(r,t)}),[m,z,e,t]),L=(0,r.useCallback)((async()=>{const e=z?n:E;if(e)try{await navigator.clipboard.writeText(e),T(!0),setTimeout((()=>T(!1)),2e3)}catch(t){const n=document.createElement("textarea");n.value=e,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),T(!0),setTimeout((()=>T(!1)),2e3)}}),[n,E,z]),D=(0,l.gR)(y,{disabled:k});return o().createElement("div",{className:D,style:b},o().createElement("div",{className:"neko-textarea-container"},o().createElement("textarea",u({ref:j,className:"neko-textarea",rows:i,disabled:k},S,{name:t,spellCheck:"false",placeholder:s,onChange:$,onKeyPress:n=>{if(d&&!n.shiftKey&&"Enter"===n.key){if(f&&O)return;n.preventDefault(),e.onEnter(n.target.value,t)}},onBlur:r=>{(h||e.onBlur&&n!==r.target.value)&&e.onBlur(r.target.value,t)},readOnly:p,style:{...v,height:g?"100%":v.height??void 0},value:z?n:E})),_&&(p||k)&&o().createElement("button",{className:"neko-textarea-copy-button",onClick:L,type:"button",title:P?"Copied!":"Copy to clipboard"},o().createElement(c.z,{icon:P?"check":"duplicate"})),o().createElement("div",{className:"neko-text-area-extra"},a?"string"==typeof a?o().createElement("div",{className:"neko-input-description",dangerouslySetInnerHTML:{__html:a}}):o().createElement("div",{className:"neko-input-description"},a):x?o().createElement("div",null):null,x&&o().createElement("div",{className:"neko-textarea-count"},A,m?` / ${m}`:""," ","words"===x?"words":"chars"))))}))`
...
`,d=e=>{const{show:t=!0,className:n,...r}=e,i=(0,l.gR)("neko-pro-only",n);return t?o().createElement(u,c({href:"https://meowapps.com",target:"_blank",className:i},r),"Pro Only"):null},h=e=>o().createElement(d,e);h.propTypes={show:a().bool,className:a().string}},4461:(e,t,n)=>{"use strict";n.d(t,{z:()=>g});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(4977),c=n(6031),u=n(2557),d=n(6897);function h(){return h=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},h.apply(this,arguments)}const p=s.Ay.div`
  font-size: var(--neko-font-size);
  margin-bottom: 15px;
...
`,f=e=>{const{title:t,subtitle:n,children:r,className:i="",busy:a=!1,style:s={},contentStyle:f={},action:g,mwaiPillTooltip:m="",mwaiPill:y=!1,mwaiEnabled:b=!1,maxHeight:v,...x}=e,k=(0,d.gR)("neko-block",i),w=y?o().createElement(o().Fragment,null,y?b?o().createElement(c.B,{tooltip:m,variant:"ai"},"AI Engine"):o().createElement("a",{href:"https://meowapps.com/ai-engine/",target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:"6px",padding:"4px 12px",borderRadius:"999px",backgroundColor:"#fee",color:"#c33",fontSize:"12px",textDecoration:"none",transition:"all 0.2s ease",cursor:"pointer",border:"1px solid #fcc"},onMouseEnter:e=>{e.currentTarget.style.backgroundColor="#fdd",e.currentTarget.style.color="#a22"},onMouseLeave:e=>{e.currentTarget.style.backgroundColor="#fee",e.currentTarget.style.color="#c33"}},o().createElement("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},o().createElement("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),o().createElement("polyline",{points:"7 10 12 15 17 10"}),o().createElement("line",{x1:"12",y1:"15",x2:"12",y2:"3"})),"AI Engine"):null,g):g;return o().createElement(p,h({className:k,style:s},x),t&&o().createElement("div",{className:"neko-block-title-section "+(n?"has-subtitle":"")},o().createElement("div",{className:"neko-block-header"},o().createElement("div",{className:"neko-block-titles"},o().createElement(l.s,{h2:!0,className:"neko-block-title"},t),n&&o().createElement("div",{className:"neko-block-subtitle"},n)),!!w&&o().createElement("div",{className:"neko-block-action"},w))),o().createElement(u.A,{busy:a},o().createElement("div",{className:"neko-block-content",style:{...f,...v?{maxHeight:v,overflowY:"auto"}:{}}},r)))},g=e=>o().createElement(f,e);g.propTypes={title:a().string,subtitle:a().string,className:a().oneOf(["","primary","standard","raw"]),style:a().object,contentStyle:a().object,action:a().element,busy:a().bool,mwaiPill:a().bool,mwaiEnabled:a().bool,maxHeight:a().oneOfType([a().string,a().number])}},8668:(e,t,n)=>{"use strict";n.d(t,{Zc:()=>g,y2:()=>f});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185);const l=s.Ay.div`
  margin-bottom: 10px;
`,c=s.Ay.div`
  margin-bottom: 0px;
  padding-bottom: 2px;
...
`,h=({children:e,keepState:t})=>{const[n,i]=(0,r.useState)((()=>{if(!t)return null;try{return JSON.parse(localStorage.getItem(t))}catch{return null}}));(0,r.useEffect)((()=>{t&&localStorage.setItem(t,JSON.stringify(n))}),[n,t]);return o().createElement("div",{className:"neko-accordions"},o().Children.map(e,((e,r)=>{var a;return(null==e?void 0:e.type)===p||(null==e?void 0:e.type)===f||(null==e?void 0:e.type)===m||"NekoCollapsableCategoryDeprecated"===(null==e||null===(a=e.type)||void 0===a?void 0:a.name)?o().cloneElement(e,{isCollapsed:n!==r,onClick:()=>{var e;i(n===(e=r)?null:e)},keepState:t?`${t}-${r}`:e.props.keepState}):e})))};h.propTypes={children:a().node.isRequired,keepState:a().string};const p=({isCollapsed:e=!1,children:t,onClick:n=(()=>{}),keepState:i,disabled:a=!1,hide:s=!1,title:h,style:p})=>{const[f,g]=(0,r.useState)(e),[m,y]=(0,r.useState)(!1),b=o().Children.count(t)>0,v=(0,r.useRef)(null),[x,k]=(0,r.useState)(0);var w,_;return w=v,_=()=>{v.current&&k(v.current.scrollHeight)},(0,r.useEffect)((()=>{const e=w.current;if(!e)return;const t=new ResizeObserver((e=>{_()}));return t.observe(e),()=>t.disconnect()}),[w,_]),(0,r.useEffect)((()=>{if(i){let t=null;try{t=JSON.parse(localStorage.getItem(i))}catch{}g(null!==t?t:e)}}),[i,e]),(0,r.useEffect)((()=>{i&&localStorage.setItem(i,JSON.stringify(f))}),[f,i]),(0,r.useEffect)((()=>{g(e)}),[e]),s?null:o().createElement(l,{className:"neko-accordion",style:p},o().createElement(c,{onClick:()=>{b&&!a&&(y(!0),g(!f),n())},style:{opacity:a?.5:1,pointerEvents:a?"none":"auto"}},h,b&&o().createElement(u,{$isCollapsed:f})),o().createElement(d,{$isCollapsed:f,$contentHeight:x,$animate:m},o().createElement("div",{ref:v},t)))};p.propTypes={title:a().string.isRequired,isCollapsed:a().bool,children:a().node,onClick:a().func,keepState:a().string,disabled:a().bool,hide:a().bool};const f=p,g=h,m=e=>(console.warn("[NekoUI] NekoCollapsableCategory is deprecated. Please use NekoAccordion instead."),o().createElement(p,e));m.propTypes=p.propTypes},1543:(e,t,n)=>{"use strict";n.d(t,{L:()=>h});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(6897);const c=s.Ay.div`
  font-size: var(--neko-font-size);
  font-family: var(--neko-font-family);
  background-color: white;
  color: var(--neko-font-color);
...
`,h=e=>{let{height:t=null,tiny:n=!1,small:r=!0,medium:i=!1,large:a=!1,line:s=!1,style:h,children:p,...f}=e;return t||(p||i?t=30:n?t=5:a?t=45:r&&(t=15)),o().createElement(c,l({className:"neko-spacer",height:t,style:h},f),p&&o().createElement(d,{line:s},p),!p&&o().createElement(u,null,s&&o().createElement("hr",null)))};h.propTypes={height:a().number,line:a().bool,tiny:a().bool,small:a().bool,medium:a().bool,large:a().bool,style:a().object}},9425:(e,t,n)=>{"use strict";n.d(t,{J:()=>g});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(6897),c=n(8135);function u(){return u=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},u.apply(this,arguments)}const d=s.Ay.div`
  display: flex;
  flex-wrap: nowrap;
  position: relative;
  width: 100%;
...
`,f=e=>{const{children:t,isCollapsible:n=!0,defaultCollapsed:i=!1,isCollapsed:a,onToggle:s,onCollapseChange:c,sidebarFlex:f=1,mainFlex:g=2,sidebarMaxWidth:m="400px",minimal:y=!1,className:b="",...v}=e,x=void 0!==a,[k,w]=(0,r.useState)(i),_=x?a:k,S=(0,l.gR)("neko-splitview",b,{collapsed:_}),E=o().Children.toArray(t),C=E[0],A=E[1];return o().createElement(d,u({className:S},v),o().createElement(h,{className:"neko-splitview-main",$flex:g,$minimal:y},C),o().createElement(p,{className:"neko-splitview-sidebar",$flex:f,$maxWidth:m,$minimal:y},A))},g=e=>o().createElement(c.YS,null,o().createElement(f,e)),m=({children:e})=>e,y=({children:e})=>e;g.Main=m,g.Sidebar=y,g.propTypes={isCollapsible:a().bool,defaultCollapsed:a().bool,isCollapsed:a().bool,onToggle:a().func,onCollapseChange:a().func,sidebarFlex:a().number,mainFlex:a().number,sidebarMaxWidth:a().string,minimal:a().bool,className:a().string,children:a().node.isRequired},m.propTypes={children:a().node},y.propTypes={children:a().node}},4547:(e,t,n)=>{"use strict";n.d(t,{N:()=>g,Y:()=>m});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(6897),c=n(8135);function u(){return u=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},u.apply(this,arguments)}const d=s.Ay.div`
  display: flex;
  flex-wrap: wrap;
...
`,l=({value:e=1e3,min:t=0,max:n=2500,width:r=200,background:i="#007cba",children:a})=>{const l=180*(e<=n?e:n)/n;return o().createElement(s,{className:"neko-gauge",backgroundColor:i,degrees:l,width:r},o().createElement("div",{className:"gauge"},o().createElement("div",{className:"mask"},o().createElement("div",{className:"semi-circle"}),o().createElement("div",{className:"semi-circle--mask"})),o().createElement("div",{className:"child-container"},o().createElement("div",{className:"child"},o().createElement("div",{className:"spacing"}),a))))};l.propTypes={value:a().number,min:a().number,max:a().number,width:a().number,background:a().string}},2158:(e,t,n)=>{"use strict";n.d(t,{n:()=>p});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(9491);const c=s.Ay.span`
...
`,h=e=>{const{title:t="NekoUI",section:n=null,subtitle:r="By Meow Apps",children:i,isPro:a=!1,showFreeBadge:s=!0}=e,h=a?"PRO VERSION":"FREE VERSION";return o().createElement(d,{className:"neko-header"},(a||s)&&o().createElement("div",{style:{position:"absolute",top:"0px",left:"50%",transform:"translateX(-50%)",zIndex:10}},a?o().createElement(c,null,h):o().createElement(u,{href:"https://meowapps.com",target:"_blank",rel:"noopener noreferrer",onMouseEnter:e=>{e.currentTarget.textContent="UPGRADE TO PRO ↗"},onMouseLeave:e=>{e.currentTarget.textContent=h}},h)),o().createElement("div",{className:"neko-header-logo-container"},o().createElement(l.r,null)),o().createElement("div",{className:"neko-header-title-container"},o().createElement("div",{className:"neko-header-title-row"},o().createElement("h1",{className:"neko-header-title"},t),!!n&&o().createElement(o().Fragment,null,o().createElement("span",{className:"neko-header-separator"},"›"),o().createElement("span",{className:"neko-header-section"},n))),o().createElement("small",{className:"neko-header-subtitle"},o().createElement("a",{target:"_blank",href:"https://meowapps.com"},r))),o().createElement("div",{className:"neko-header-extra-content"},i))},p=e=>o().createElement(h,e);p.propTypes={title:a().string,section:a().string,subtitle:a().string,children:a().node,isPro:a().bool,showFreeBadge:a().bool}},2109:(e,t,n)=>{"use strict";n.d(t,{z:()=>g});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(2155),c=n(1546),u=n(1997),d=n(6897);const h=s.Ay.div`
  display: flex;
  align-items: center;
...
`,f={primary:{color:"var(--neko-blue)"},success:{color:"var(--neko-green)"},warning:{color:"var(--neko-yellow)"},danger:{color:"var(--neko-red)"}},g=e=>{let{icon:t,color:n,spinning:i=!1,className:a="",tooltip:s,raw:g,isBusy:m=!1,busy:y=!1,variant:b,title:v,containerStyle:x,hoverColor:k,disabled:w=!1,width:_,height:S,strokeWidth:E,...C}=e;const A=y||m;o().useEffect((()=>{m&&console.log('NekoIcon: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[m]);const M=b&&f[b]?f[b].color:n,O=b&&f[b]?f[b].hoverColor:k,R="string"==typeof t&&l.ho[t]?l.ho[t]:void 0,P=_||S||30,T=(0,r.useMemo)((()=>{if("string"==typeof t){if(l.Ay[t])return l.Ay[t];console.warn(`NekoIcon: Icon "${t}" does not exist. Available icons: ${Object.keys(l.Ay).join(", ")}`)}return t}),[t]),z=(0,r.useMemo)((()=>!!l.Ay[t]||"function"==typeof T||"object"==typeof T),[t,T]),j=(0,d.gR)("neko-icon",a,{"neko-clickable":!!C.onClick},{spin:i||A},{disabled:w}),I=()=>{if(A&&!w)return o().createElement(c.A,{size:P,className:"spin",strokeWidth:E});if(z){const e=T,{width:t,height:n,fill:r,...i}=C;return o().createElement(e,{size:P,fill:r||R||"none",strokeWidth:E,...i})}return o().createElement(p,null,T)};if(s)return"string"==typeof s&&(s={text:s}),o().createElement(u.f,{text:s.text,position:s.position||"top"},o().createElement(h,{style:x,className:j,$color:M,$hoverColor:O,title:v},I()));if(g){if(z){const e=T,{width:t,height:n,fill:r,...i}=C;return o().createElement(e,{size:P,color:M,fill:r||R||"none",className:j,strokeWidth:E,...i})}return o().createElement(p,null,T)}return o().createElement(h,{style:x,title:v,className:j,$color:M,$hoverColor:O},I())};g.propTypes={icon:a().oneOfType([a().elementType,a().oneOf(["duplicate","lock","lock-open","file-undo","chevron-double-left","chevron-double-right","chevron-left","chevron-right","chevron-down","chevron-up","pause","play","replay","check","check-circle","stop","checkbox-blank","checkbox-marked","delete","undo","alert","database","tools","cog","close","cat","upload","trash","pencil","dashboard","search","folder","folder-open","image-multiple-outline","plus","folder-plus","image-plus","view-grid","list","twitter","instagram","facebook","star","timer-outline","link","linkedin","pinterest","zoom-in","info-outline","image-off-outline","arrow-up","arrow-down","sort","eye","rocket-launch","calendar-month","wand","mastodon","filter","question","loading","new","save","reset","rename","edit","debug","external-link","download","share","mail","phone","message","bell","home"])]),color:a().string,spinning:a().bool,className:a().string,tooltip:a().string,raw:a().bool,busy:a().bool,isBusy:a().bool,variant:a().string}},1843:(e,t,n)=>{"use strict";n.d(t,{K:()=>g,o:()=>f});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(2109),c=n(6897);const u=s.Ay.div`
  display: flex;
  align-items: center;
`,d=s.Ay.span`
  color: var(--neko-main-color);
...
`,y=e=>{let{variant:t,children:n,onClose:r,small:i,...a}=e;t||(t="info");const s=(0,l.gR)("neko-message",{danger:"danger"===t},{success:"success"===t},{info:"info"===t},{warning:"warning"===t},{special:"special"===t},{disabled:"disabled"===t},{small:i}),y=i?14:20;return o().createElement(m,g({className:s,small:i},a),o().createElement((()=>{switch(t){case"danger":return c.A;case"success":return u.A;case"warning":return d.A;case"special":return h.A;default:return p.A}})(),{size:y,className:"neko-message-icon"}),o().createElement("div",{className:"neko-message-content"},n),r&&o().createElement(f.A,{size:y,className:"neko-message-close",onClick:r}))},b=e=>o().createElement(y,e);b.propTypes={variant:a().string,children:a().node,onClose:a().func,small:a().bool}},520:(e,t,n)=>{"use strict";n.d(t,{Q:()=>g});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(1422),c=n(8897),u=n(8744),d=n(2297),h=n(2155);const p=s.Ay.div`
  align-items: center;
  display: flex;
  user-select: none;
...
`,f=e=>{const{currentPage:t,limit:n=0,onClick:i,total:a=0,onCurrentPageChanged:s,infinite:f=!1,maxInfinite:g=!1,controllerText:m,compact:y=!1}=e,b=!!s,v=(0,r.useMemo)((()=>f||g?0:Math.ceil(0===a?1:n>0?a/n:1)),[f,g,n,a]),x="nako-paging-controller-icon "+(f||1!==t?"":"disabled"),k="nako-paging-controller-icon "+(f||g||t!==v?"":"disabled"),[w,_]=(0,r.useState)(!1),[S,E]=(0,r.useState)(y),C=e=>{_(!1),i(e)},A=e=>{if(f)return e;const t=Number(e);return g?t<1?1:t:t>v?v:t<1?1:t},M=e=>{const t=e.target.value;isNaN(t)||s(A(t)),_(!1)},O=e=>{if("Enter"===e.key){e.preventDefault();const t=e.target.value;isNaN(t)||s(A(t)),_(!1)}},R=(0,r.useMemo)((()=>{if(!w){const e=()=>{b&&1!==v&&_(!0)},n=b&&v>1;return o().createElement("span",{className:n?"neko-paging-current-page":"",onClick:e},t)}return o().createElement("input",{autoFocus:!0,type:"text",className:b?"neko-paging-current-page":"",defaultValue:t,onBlur:M,onKeyPress:O})}),[t,w,s,v]),P=e=>{w&&e.target===e.currentTarget&&_(!1)},T=(0,r.useRef)(null);return(0,r.useEffect)((()=>{const e=()=>{if(T.current){const e=T.current.offsetWidth;E(y||e<280)}};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)}),[y]),o().createElement(p,{className:"neko-paging",ref:T},!!a&&o().createElement("span",{className:"neko-paging-text"},a," result",a>0?"s":""),o().createElement("div",{className:"neko-paging-controller",onClick:P},!f&&!g&&o().createElement(l.A,{className:x,onClick:()=>C(1),size:h.hS.chevron}),o().createElement(c.A,{className:x,onClick:()=>C(t-1),size:h.hS.chevron}),o().createElement("p",{className:"nako-paging-controller-text",onClick:P},m||(S?o().createElement(o().Fragment,null,R,"/",v):o().createElement(o().Fragment,null,"Page ",R," of ",v))),o().createElement(u.A,{className:k,onClick:()=>C(t+1),size:h.hS.chevron}),!f&&!g&&o().createElement(d.A,{className:k,onClick:()=>C(v),size:h.hS.chevron})))},g=e=>o().createElement(f,e);g.propTypes={currentPage:a().number,limit:a().number,total:a().number,onClick:a().func,lastPage:a().number,infinite:a().bool,maxInfinite:a().bool,controllerText:a().object}},6031:(e,t,n)=>{"use strict";n.d(t,{B:()=>d});var r=n(1594),o=n.n(r),i=n(1997),a=n(7639),s=n.n(a),l=n(3185);function c(){return c=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},c.apply(this,arguments)}const u=l.Ay.div`
  display: inline-flex;
  position: relative;
  z-index: 10;
  align-items: center;
...
`,d=({className:e="primary",variant:t,children:n=null,onClick:a=null,led:s=!0,tooltip:l="",label:d,extender_label:h=null,extender_children:p=null,extender_width:f=null,link:g=null,...m})=>{o().useEffect((()=>{e&&["primary","secondary","danger","warning","success","ai"].includes(e)&&!t&&console.warn(`NekoPill: Using 'className' prop for pill variants is deprecated. Please use 'variant' prop instead. Found className="${e}"`)}),[e,t]);const y=t||(["primary","secondary","danger","warning","success","ai"].includes(e)?e:"primary"),b=e&&!["primary","secondary","danger","warning","success","ai"].includes(e)?e:"",v=(0,r.useCallback)((e=>{a&&(a(),e.stopPropagation(),e.preventDefault())}),[a]),x=o().createElement(i.f,{text:l,position:"top"},o().createElement(u,c({className:`neko-pill ${y} ${b}`.trim(),onClick:a?v:void 0},m,{link:g}),s&&o().createElement("div",{className:`led ${y}`}),d&&o().createElement("span",null,d),n));return o().createElement(o().Fragment,null,g?o().createElement("a",{href:g,target:"_blank",rel:"noopener noreferrer"},x):x,(h||p)&&o().createElement(u,{className:`pill-extender ${y}`,extender_width:f},o().createElement("div",{className:"pill-extender-inner"},h&&o().createElement("span",null,h),p)))};d.propTypes={className:s().string,variant:s().oneOf(["primary","secondary","danger","warning","success","ai"]),children:s().node,onClick:s().func,led:s().bool,extender_label:s().string,extender_children:s().node,extender_width:s().string,link:s().string}},851:(e,t,n)=>{"use strict";n.d(t,{j:()=>g});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(8160),c=n(8086),u=n(8785),d=n(6897);function h(){return h=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},h.apply(this,arguments)}const p=(0,s.Ay)((e=>{let{value:t=0,max:n=100,busy:r=!1,isBusy:i=!1,paused:a=!1,status:s,variant:p,className:g,...m}=e;const y=r||i;o().useEffect((()=>{i&&console.log('NekoProgress: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[i]),t=Math.min(t,n);let b=parseFloat(t)/parseFloat(n);const v=Math.round(100*b),x=p||(v>=100?"success":"primary"),k=(0,d.gR)("neko-progress",g);return o().createElement("div",h({className:k},m),o().createElement(f,{ratio:b,busy:y,status:s,variant:x}),o().createElement("div",{className:"neko-progress-buttons"},y&&e.onPauseClick&&o().createElement("div",{className:"neko-progress-button pause",onClick:e.onPauseClick},a?o().createElement(l.A,{size:14,fill:"rgb(255 255 255 / 25%)"}):o().createElement(c.A,{size:14,fill:"rgb(255 255 255 / 25%)"})),y&&e.onStopClick&&o().createElement("div",{className:"neko-progress-button stop",onClick:e.onStopClick},o().createElement(u.A,{size:14,fill:"rgb(255 255 255 / 25%)"}))))}))`
  position: relative;
  box-sizing: border-box;
  height: 30px;
  background: linear-gradient(
...
`,g=e=>o().createElement(p,e);g.propTypes={value:a().number,max:a().number,busy:a().bool,isBusy:a().bool,paused:a().bool,variant:a().oneOf(["primary","success","warning","danger","info"]),onPauseClick:a().func,onStopClick:a().func,status:a().oneOf([a().string,a().func])}},6087:(e,t,n)=>{"use strict";n.d(t,{X:()=>m});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(6897),c=n(2109);function u(){return u=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},u.apply(this,arguments)}const d=s.Ay.div`
  width: ${e=>e.size||"50%"};
...
`,f=({className:e,size:t="24px",color:n="#666",...r})=>{const i=(0,l.gR)("neko-spinner-icon",e),a=parseInt(t);return o().createElement(p,u({className:i,size:t},r),o().createElement(c.z,{icon:"sync",width:a,height:a,color:n,raw:!0}))},g=e=>{const{type:t="icon",...n}=e;return"circle"===t?o().createElement(h,n):o().createElement(f,n)},m=e=>o().createElement(g,e);m.propTypes={type:a().oneOf(["circle","icon"]),size:a().string,color:a().string}},1997:(e,t,n)=>{"use strict";n.d(t,{f:()=>f});var r=n(1594),o=n.n(r),i=n(5206),a=n.n(i),s=n(7639),l=n.n(s),c=n(3185),u=n(6897);const d=c.Ay.div`
  display: inline-block;
`,h=c.Ay.div`
...
`,p=e=>{const{text:t="Hello world!",position:n="top",maxWidth:i=160}=e,[s,l]=(0,r.useState)(!1),c=(0,u.G8)((e=>l(e)),100),[p,f]=(0,r.useState)({top:0,left:0}),g=(0,r.useRef)(null);return(0,r.useEffect)((()=>{if(s&&g.current){const e=g.current.getBoundingClientRect();let t=0,r=0;const o=window.scrollY||window.pageYOffset,i=window.scrollX||window.pageXOffset;switch(n){case"top":t=e.top+o,r=e.left+e.width/2+i;break;case"bottom":t=e.bottom+o,r=e.left+e.width/2+i;break;case"left":t=e.top+e.height/2+o,r=e.left+i;break;case"right":t=e.top+e.height/2+o,r=e.right+i}f({top:t,left:r})}}),[s,n]),o().createElement(d,{className:"neko-tooltip",ref:g,style:e.style,onMouseEnter:()=>t&&c(!0),onMouseLeave:()=>c(!1)},e.children,a().createPortal(o().createElement(h,{visible:s,position:n,$maxWidth:i,style:{top:p.top,left:p.left}},"string"==typeof t?t.split("\n").map(((e,t)=>o().createElement(o().Fragment,{key:t},e,o().createElement("br",null)))):t),document.body))},f=e=>e.text?o().createElement(p,e):e.children||null;f.propTypes={style:l().object,text:l().string,position:l().oneOf(["top","right","bottom","left"]),maxWidth:l().number}},4977:(e,t,n)=>{"use strict";n.d(t,{s:()=>k});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(6897);function c(){return c=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},c.apply(this,arguments)}const u="\n  font-family: var(--neko-font-family);\n  font-weight: normal;\n  line-height: normal;\n  margin-top: 0;\n  margin-bottom: 16px;\n  padding: 0;\n",d=s.Ay.h1`
  ${u}
...
`,v=s.Ay.label`
  ...
  margin: 0;
  padding: 0;
`,x=e=>{const{children:t=null,style:n={},className:r="",bold:i=!1,h1:a,h2:s,h3:u,h4:x,h5:k,h6:w,p:_,span:S,label:E,...C}=e,A=i?{fontWeight:"bold"}:{},M=(0,l.gR)("neko-typo",r,{"neko-typo-h1":a},{"neko-typo-h2":s},{"neko-typo-h3":u},{"neko-typo-h4":x},{"neko-typo-h5":k},{"neko-typo-h6":w},{"neko-typo-p":_},{"neko-typo-label":E});return a?o().createElement(d,c({style:{...A,...n},className:M},C),t):s?o().createElement(h,c({style:{...A,...n},className:M},C),t):u?o().createElement(p,c({style:{...A,...n},className:M},C),t):x?o().createElement(f,c({style:{...A,...n},className:M},C),t):k?o().createElement(g,c({style:{...A,...n},className:M},C),t):w?o().createElement(m,c({style:{...A,...n},className:M},C),t):_?o().createElement(y,c({style:{...A,...n},className:M},C),t):E?o().createElement(v,c({style:{...A,...n},className:M},C),t):o().createElement(b,c({style:{...A,...n},className:M},C),t)},k=e=>o().createElement(x,e);k.propTypes={h1:a().any,h2:a().any,h3:a().any,h4:a().any,h5:a().any,h6:a().any,p:a().any,span:a().any,label:a().any,bold:a().bool,style:a().object,className:a().string,children:a().node}},209:(e,t,n)=>{"use strict";n.d(t,{Z:()=>p});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(8135),c=n(2557),u=n(6897);function d(){return d=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},d.apply(this,arguments)}const h=s.Ay.div`
  &.dropping {
    background: #a4d5ff;
  }
`,p=(0,r.forwardRef)(((e,t)=>{const{onSuccess:n=(()=>{}),onFailure:i=(()=>{}),apiUrl:a,onSelectFiles:s=(()=>{}),apiConfig:p,className:f,disabled:g=!1,children:m,multiple:y,accept:b="image/*",...v}=e,[x,k]=(0,r.useState)(!1),[w,_]=(0,r.useState)(!1),S=a,E=(0,r.useCallback)((async e=>{_(!0);const t=await Promise.all(e.map((async e=>await(async e=>{const t={...p,file:e};return await(0,l.Tb)(a,t)})(e)))),r=t.filter((e=>e.success)),o=t.filter((e=>!e.success));r.length&&n(y?r:r[0]),o.length&&i(y?o:o[0]),_(!1)}),[a,y,p,n,i]),C=(0,r.useCallback)(((e,t)=>{t.preventDefault(),t.stopPropagation(),k(!1),S?E(e):s(e)}),[S,E]),A=(0,r.useCallback)((e=>{e.preventDefault(),e.stopPropagation()}),[]),M=(0,r.useCallback)((e=>{e.preventDefault(),e.stopPropagation(),g||k(!0)}),[g]),O=(0,r.useCallback)((e=>{e.preventDefault(),e.stopPropagation(),g||k(!1)}),[g]),R=(0,r.useCallback)((e=>{if(e.preventDefault(),e.stopPropagation(),g)return;const t=[...e.dataTransfer.files];e.target.value=null,C(t,e)}),[g,C]),P=(0,r.useCallback)((e=>{const t=[...e.target.files];e.target.value=null,C(t,e)}),[C]),T=(0,u.gR)("neko-upload-drop-area",f,{dropping:x});return o().createElement(c.A,{busy:w},o().createElement("input",{type:"file",accept:".csv, .json, .jsonl, .txt",ref:t,onChange:P,style:{display:"none"},multiple:y,disabled:g}),o().createElement(h,d({className:T,onDragOver:A,onDragEnter:M,onDragLeave:O,onDrop:R},v),m))}));p.propTypes={ref:a().ref,onSuccess:a().func,onFailure:a().func,onSelectFiles:a().func,apiUrl:a().string,apiConfig:a().object,disabled:a().bool}},9794:(e,t,n)=>{"use strict";n.d(t,{n:()=>y});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3062),l=n.n(s),c=n(3185),u=n(9296),d=n(6897);function h(){return h=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},h.apply(this,arguments)}const p=c.DU`
...
`,g=["disabled","ok","okOnClick","okDisabled","cancel","cancelOnClick","cancelDisabled"],m=e=>{const{className:t,style:n,contentStyle:i,title:a="",content:s="",contentWidth:c,customButtons:m=null,okOnEnter:y=!1,thumbnail:b,okButton:v={},cancelButton:x={},action:k=null,isOpen:w,children:_,customButtonsPosition:S="right",size:E="normal",fullSize:C=!1,...A}=e,M=E||(C?"full-size":"normal"),O="full-size"===M,R=(0,d.gR)("neko-modal",t,{large:"large"===M,larger:"larger"===M,"full-size":O,"custom-modal":n}),{label:P="OK",...T}=v,{label:z="Cancel",...j}=x;(0,r.useEffect)((()=>{const t=g.filter((t=>void 0!==e[t]));t.length&&console.warn(`[Deprecated] NekoUI: Button attributes ${t.join(", ")} are deprecated in NekoModal.\nPlease use: okButton={{ label, onClick, disabled }} and cancelButton={{ ... }}`,{props:e})}),[e]);const I=(0,r.useCallback)((({key:e})=>{"Enter"===e&&T.onClick&&T.onClick()}),[T]);(0,r.useEffect)((()=>{if(y&&w)return window.addEventListener("keyup",I),()=>window.removeEventListener("keyup",I)}),[y,w,I]);const N=_||o().createElement(f,{size:M,contentWidth:c},O&&a&&o().createElement("div",{className:"full-size-header"},o().createElement("p",{className:"title"},a),k&&o().createElement("div",{className:"button-group"},k)),!O&&a&&o().createElement("p",{className:"title"},a),o().createElement("div",{className:"content-container"},b&&o().createElement("div",{className:"thumbnail"},b),s&&o().createElement("div",{className:"content",style:i},s)),o().createElement("div",{className:"button-group"+(O?" full-size-footer":"")},o().createElement(o().Fragment,null,m&&"left"===S&&m,j.onClick&&o().createElement(u.M,h({className:"danger"},j),z),T.onClick&&o().createElement(u.M,T,P),m&&"right"===S&&m)));return o().createElement(o().Fragment,null,o().createElement(p,null),o().createElement(l(),h({ariaHideApp:!1,closeTimeoutMS:200,className:R,style:n,isOpen:w},A),N))},y=e=>o().createElement(m,e);y.propTypes={className:a().string,style:a().object,contentStyle:a().object,title:a().string,content:a().string,contentWidth:a().string,customButtons:a().object,okOnEnter:a().bool,thumbnail:a().element,okButton:a().object,cancelButton:a().object,action:a().element,size:a().oneOf(["normal","large","larger","full-size"]),fullSize:a().bool,isOpen:a().bool.isRequired}},5900:(e,t,n)=>{"use strict";n.d(t,{o:()=>R});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(2480),c=n(9685),u=n(2155),d=n(2557),h=n(5263),p=n(6897);var f=n(2109),g=n(374),m=n(4536),y=n(9442),b=n(9296),v=n(6734),x=n(8696);const k=s.Ay.div`
  min-width: 160px;
  padding: 8px;
  border-radius: 8px;
  overflow: hidden;
...
`,w=({accessor:e,options:t,type:n="checkbox",onChange:o,description:i,filters:a})=>{const[s,l]=(0,r.useState)(!1),[c,u]=(0,r.useState)(a||""),[d,p]=(0,r.useState)(a||""),w=(0,r.useRef)(null),_=(0,r.useRef)(null),S="text"===n;(0,r.useEffect)((()=>{S&&a!==c&&(u(a||""),p(a||""))}),[a,S]);const E=a&&a.length>0||c.length>0,C="checkbox"===n,A="select"===n,M=(t=void 0)=>{void 0!==t&&t!==c&&u((()=>t)),d!==c&&(o(e,d),u(d))};return(0,r.useEffect)((()=>{M(),s&&setTimeout((()=>{_.current&&_.current.focus()}),10)}),[s]),React.createElement(React.Fragment,null,React.createElement("div",{ref:w},React.createElement(f.z,{icon:"filter",fill:E?"white":void 0,onClick:()=>l(!s),width:16,height:16})),React.createElement(g.G,{visible:s,targetRef:w,onClose:()=>l(!1)},React.createElement(k,{className:"neko-table-filters"},React.createElement("div",{className:"neko-context-menu"},!!i&&React.createElement("p",{style:{marginTop:0,marginBottom:5}},i),React.createElement("div",{className:"neko-context-content"},C&&React.createElement(m.E,{name:"neko-context-menu-checkboxes"},t.map((t=>React.createElement(h.R,{small:!0,key:t.value,label:t.label,checked:null==a?void 0:a.includes(t.value),onChange:n=>{if(a)return o(e,n?[...a,t.value]:a.filter((e=>e!=t.value)));console.error("[NekoUI] filters needs to be set for the NekoTable.",{accessor:e,option:t.value})}})))),A&&React.createElement(y.u,{name:"neko-context-menu-select",onChange:t=>o(e,t)},t.map((e=>React.createElement(y.j,{id:e.value,key:e.value,label:e.label,value:e.value,checked:a===e.value}))))),S&&React.createElement(x.A,{ref:_,name:"neko-context-menu-text",value:d,onChange:e=>p(e),onEnter:e=>{M(e),l(!1)}}),React.createElement(v.g,{tiny:!0}),React.createElement("div",{className:"neko-context-menu-bottom-actions"},React.createElement(b.M,{fullWidth:!0,disabled:!E,onClick:()=>{o(e,C?[]:null),p(""),l(!1),u("")}},"Reset"))))))};function _(){return _=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},_.apply(this,arguments)}w.propTypes={accessor:a().string,options:a().array,type:a().oneOf(["checkbox","select","text"]),onChange:a().func,filters:a().oneOfType([a().string,a().array])};const S=s.Ay.table`
  font-family: var(--neko-font-family);
  border-spacing: 0;
  width: 100%;
...
`,E=e=>{const{checked:t,indeterminate:n,onSelect:r=(()=>{}),onUnselect:i=(()=>{}),isBusy:a=!1,busy:s=!1}=e,l=s||a;return o().useEffect((()=>{a&&console.log('TableCheckBox: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[a]),o().createElement(h.R,{small:!0,onChange:(e,t,n)=>e?r(n):i(n),checked:t,indeterminate:n,busy:t&&l,disabled:l})},C=(e,t=!1)=>{let n={};return e.align&&(n={textAlign:e.align}),t&&e.verticalAlign&&(n={...n,verticalAlign:e.verticalAlign}),e.style&&(n={...n,...e.style}),n},A=e=>!0===e?"#edf8ff":e,M=(e,t)=>{console.log("[NekoUI] Missing implementation for onFilterChange.",{filter:e,value:t})},O=e=>{const{data:t=[],selectedItems:n=[],selectedRow:i,filters:a,onFilterChange:s=M}=e,{columns:h=[],busy:f=!1,isBusy:g=!1,onSelect:m,onSelectRow:y,selectOnRowClick:b=!0,onUnselect:v,onSortChange:x=(()=>{}),variant:k="default",alternateRowColor:O=!1,sort:R,emptyMessage:P="Empty.",initialLoad:T=!1}=e,z=f||g;o().useEffect((()=>{g&&console.log('NekoTable: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[g]);h.length;const j=t.some((e=>void 0===e.id));j&&console.warn('Table data is missing the "id" field. Using the index as id instead, and disabling the row selection.');const I=j?t.map(((e,t)=>void 0===e.id?{...e,id:-(t+1),disabled_row:!0}:e)):t,N=(e=>e?{backgroundColor:A(e)}:{})(O),$=I.map((e=>{const t=h.map((t=>({value:e[t.accessor],style:C(t,!0)})));return{id:e.id,disabled_row:null==e?void 0:e.disabled_row,isBusy:e.isBusy||!1,cells:t}})),L=I.map((e=>({id:e.id}))),{onSelect:D}=(({list:e,selectedList:t,callback:n,key:o="id"})=>{const{pressShift:i}=(0,p.v_)(),a=(0,r.useMemo)((()=>{if(!i||!t.length)return null;const n=t[t.length-1];return e.findIndex((e=>e[o]===n))}),[o,e,i,t]);return{onSelect:(0,r.useCallback)((r=>{if(!n)return;if(null===a)return void n([...r]);const i=r[0],s=e.findIndex((e=>e[o]===i)),l=(a<s?a:s)+1,c=a<s?s:a,u=e.slice(l,c).map((e=>e[o])).filter((e=>!t.some((t=>t===e))));n([...u,...r])}),[a,e,n,t,o])}})({list:L,selectedList:n,callback:m}),F=$.map((e=>e.id)),B=0===F.length,H=F.filter((e=>n.includes(e))),W=!B&&H.length===F.length,q=!W&&n.length>0,U=h.reduce((function(e,t,n){return!1===t.visible&&e.push(n),e}),[]),V=!!m&&!B,K=o().createElement("tr",null,V&&o().createElement("th",{className:"table-checkbox-cell"},o().createElement(E,{checked:W,indeterminate:q,onSelect:e=>m(F,e),onUnselect:e=>{v(q?n:F,e)}})),h.filter(((e,t)=>!U.includes(t))).map((e=>{let t=R&&R.accessor===e.accessor,n=R&&"asc"===R.by;const r=C(e);return o().createElement("th",{style:r,key:e.accessor},o().createElement("div",null,o().createElement("div",null,e.title),o().createElement("div",{style:{flex:"auto"}}),e.filters&&o().createElement("div",{className:"neko-column-action"},o().createElement(w,_({accessor:e.accessor},e.filters,{onChange:(e,t)=>s(e,t),filters:(()=>{let t=(null==a?void 0:a.find((t=>t.accessor===e.accessor)))??null;return(null==t?void 0:t.value)??null})()}))),e.sortable&&o().createElement("div",{className:"neko-column-action",onClick:r=>{let o=R&&R.accessor!==e.accessor;x(e.accessor,o||t&&n?"desc":"asc",r)}},t?n?o().createElement(c.A,{className:"neko-active",size:u.hS.chevron}):o().createElement(l.A,{className:"neko-active",size:u.hS.chevron}):o().createElement(l.A,{className:t?"neko-active":"",size:u.hS.chevron}))))}))),Q=(0,p.gR)("neko-table",`neko-table-${k}`,{"neko-row-selectable":!!y}),Y=((e,t)=>{const n=e.filter((e=>!1!==e.visible)),r=t?["34px"]:[];return n.forEach((e=>{if(e.width)if(e.width.endsWith("%")){const t=parseFloat(e.width)/100;r.push(`${t}fr`)}else r.push(e.width);else r.push("1fr")})),r.join(" ")})(h,V);return o().createElement(d.A,{busy:z,spinnerTop:!0,overlayStyle:{top:"36px",bottom:"default"===k?"36px":0,height:"auto",borderRadius:0}},o().createElement(S,{className:Q,$gridColumns:Y},o().createElement("thead",null,K),o().createElement("tbody",null,!$.length&&!T&&o().createElement("tr",null,o().createElement("td",{style:{gridColumn:"1 / -1",textAlign:"center",minHeight:40,color:"gray"}},P)),$.map(((e,t)=>{const r=!!i&&i===e.id||n.includes(e.id),a=r||t%2!=0?{}:N;return o().createElement("tr",{key:`neko-row-${e.id}`,className:r?"selected":"",style:a,onClick:t=>{t.stopPropagation(),y&&b&&y(e.id,t)}},V&&o().createElement("td",{className:"table-checkbox-cell"},o().createElement(E,{checked:n.includes(e.id),onSelect:t=>{t.stopPropagation(),D([e.id],t)},onUnselect:t=>{t.stopPropagation(),v([e.id],t)},isBusy:e.isBusy||(null==e?void 0:e.disabled_row)})),e.cells.map(((e,t)=>({...e,origIdx:t}))).filter((e=>!U.includes(e.origIdx))).map((t=>o().createElement("td",{key:`${e.id}-${t.origIdx}`,style:t.style},t.value))))}))),"default"===k&&o().createElement("tfoot",null,K)))},R=e=>o().createElement(O,e);R.propTypes={columns:a().arrayOf(a().any),data:a().arrayOf(a().any),busy:a().bool,isBusy:a().bool,onSelect:a().func,onSelectRow:a().func,selectOnRowClick:a().bool,onUnselect:a().func,selectedItems:a().arrayOf(a().any),onSortChange:a().func,variant:a().string,alternateRowColor:a().oneOfType([a().bool,a().string]),initialLoad:a().bool}},3676:(e,t,n)=>{"use strict";n.d(t,{V:()=>D,_:()=>L});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i),s=n(3185),l=n(1329),c=n(2109),u=n(374),d=n(8696),h=n(4977),p=n(6031),f=n(2480),g=n(6897),m=n(2557);function y(){return y=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},y.apply(this,arguments)}const b=320,v=120,x=72,k=5,w=2,_=44,S=12,E=.25,C=s.Ay.div`
  display: flex;
  align-items: stretch;
  position: relative;
  height: 39px;
...
`,I=(e=6)=>{const t="abcdefghijklmnopqrstuvwxyz0123456789";let n="";for(let r=0;r<e;r++)n+=t[36*Math.random()|0];return n},N=e=>{const{title:t,subtitle:n,inversed:i,children:a,action:s,isPro:m,currentTab:P,onChange:N,keepTabOnReload:$=!1,callOnTabChangeFirst:L=!0,mwaiPill:D=!1,mwaiEnabled:F=!1,minWidth:B=x,idealWidth:H=v,maxWidth:W=b,gap:q=k,minGap:U=w,chevronReserve:V=_,layoutBuffer:K=S,ariaLabel:Q="Tabs",...Y}=e,G=(0,r.useRef)(`nt-${I(8)}`).current,X=(0,r.useRef)(null),Z=(0,r.useRef)(null),J=(0,r.useRef)(null),ee=(0,r.useRef)(null),te=(0,r.useRef)([]),ne=(0,r.useRef)({key:"",widths:{}}),[re,oe]=(0,r.useState)([]),[ie,ae]=(0,r.useState)(!1),[se,le]=(0,r.useState)(""),[ce,ue]=(0,r.useState)(!1),[de,he]=(0,r.useState)(q),[pe,fe]=(0,r.useState)((()=>{if("string"==typeof P)return P;if($&&"undefined"!=typeof window)try{return new URL(window.location.href).searchParams.get("nekoTab")||""}catch{}return""})),ge=(0,r.useRef)(!1);(0,r.useEffect)((()=>{he(q)}),[q]);const me=(0,r.useCallback)((e=>{var t;if("undefined"!=typeof window&&null!==(t=history)&&void 0!==t&&t.replaceState&&"string"==typeof e)try{const t=new URLSearchParams(window.location.search);t.set("nekoTab",e);const n=window.location.protocol+"//"+window.location.host+window.location.pathname+"?"+t.toString();window.history.replaceState({path:n},"",n)}catch{}}),[]),ye=(0,r.useMemo)((()=>{const e=[];return o().Children.forEach(a,(t=>{o().isValidElement(t)&&e.push(t)})),e}),[a]),be=(0,r.useMemo)((()=>{const e=new Set;return ye.map(((t,n)=>{let r=t.key||((e,t)=>{const n=e.props||{};let r="tab-"+(t+1);return e.key?r=e.key:"string"==typeof n.title&&(r=n.title.toLowerCase().replace(/[^a-z0-9\u4e00-\u9fa5\u3040-\u309f\u30a0-\u30ff\u2e80-\u2eff\u31f0-\u31ff\u3200-\u32ff\u3400-\u4dbf\uf900-\ufaff ]/gi,"").replace(/ /g,"-")),r})(t,n);e.has(r)&&(r=`${r}-${I()}`),e.add(r);const{title:o=`Untitled Tab ${n+1}`,requirePro:i=!1,hidden:a=!1,icon:s=null,busy:l=!1,isBusy:c=!1}=t.props||{};return{key:r,title:o,requirePro:!m&&i,hidden:a,icon:s,busy:l||c}}))}),[ye,m]),ve=(0,r.useMemo)((()=>be.map((e=>e.key))),[be]),xe=(0,r.useCallback)(((e,t,n)=>{t&&!t.requirePro&&(void 0===P&&pe!==t.key&&fe(t.key),N&&N(e,t,n),$&&me(t.key))}),[P,pe,N,$,me]),ke=(0,r.useMemo)((()=>{const e=new Set(re),t=[];for(let n=0;n<be.length;n++){const r=be[n];r&&(r.hidden||e.has(n)||t.push(n))}return t}),[re,be]),we=(0,r.useCallback)((e=>{const t=te.current[e];t&&t.focus&&t.focus({preventScroll:!0})}),[]),_e=(0,r.useCallback)(((e,t)=>{if(!ke.length)return;const n=ke.indexOf(e),r=-1===n?0:(n+t+ke.length)%ke.length,o=ke[r],i=be[o];i&&!i.requirePro&&(xe(o,i),we(o))}),[ke,be,xe,we]),Se=(0,r.useCallback)((e=>t=>{switch(t.key){case"ArrowRight":t.preventDefault(),_e(e,1);break;case"ArrowLeft":t.preventDefault(),_e(e,-1);break;case"Home":if(t.preventDefault(),ke.length){const e=ke[0],t=be[e];t&&!t.requirePro&&(xe(e,t),we(e))}break;case"End":if(t.preventDefault(),ke.length){const e=ke[ke.length-1],t=be[e];t&&!t.requirePro&&(xe(e,t),we(e))}}}),[ke,be,xe,we]),Ee=(0,r.useCallback)((e=>{const t=te.current[e];if(!t||"undefined"==typeof window)return H;const n=window.getComputedStyle(t);let r=(parseFloat(n.paddingLeft)||0)+(parseFloat(n.paddingRight)||0);const o=Array.from(t.children);for(const e of o){const t=e.getBoundingClientRect().width||0;if(e.classList&&e.classList.contains("neko-tab-label")){r+=Math.max(e.scrollWidth||0,t)}else r+=t}const i="number"==typeof W?W:Number.MAX_SAFE_INTEGER;return Math.min(r,i)}),[H,W]),Ce=(0,r.useCallback)((()=>{const e=X.current;if(!e)return;const t=e.clientWidth,n=ee.current?ee.current.offsetWidth:0,r=Z.current?Z.current.offsetWidth:0,o=[];te.current.forEach(((e,t)=>{const n=be[t];e&&n&&!n.hidden&&o.push(t)}));const i=o.length;if(0===i)return oe((e=>e.length?[]:e)),ue(!1),void he((e=>Math.abs(e-q)<E?e:q));const a=K,s=t-r-a,l=o.join(",");if(ne.current.key!==l){const e={};o.forEach((t=>{e[t]=Ee(t)})),ne.current={key:l,widths:e}}const{widths:c}=ne.current,u=o.reduce(((e,t)=>e+(c[t]||H)),0),d=ee.current?1:0,h=u+n+(i-1+d)*q;if(h<=s)return ue(!1),oe((e=>e.length?[]:e)),void he((e=>Math.abs(e-q)<E?e:q));const p=i-1+d;if(p>0&&U<q){const e=h-s;if(e>0&&e<=p*(q-U)+.5){const t=Math.max(U,q-e/p);return ue(!1),oe((e=>e.length?[]:e)),void he((e=>Math.abs(e-t)<E?e:t))}}if(Math.floor((s-n+q)/(B+q))>=i)return ue(!0),oe((e=>e.length?[]:e)),void he((e=>Math.abs(e-q)<E?e:q));const f=t-Math.max(r,V)-a;let g=Math.floor((f-n+q)/(B+q));g=Math.max(1,Math.min(g,i));let m=o.slice(0,g),y=o.slice(g);const b=be.findIndex((e=>e&&e.key===pe));if(-1!==b&&!m.includes(b)&&o.includes(b)){m[m.length-1]=b;const e=new Set(m);y=o.filter((t=>!e.has(t)))}ue(!0),he((e=>Math.abs(e-q)<E?e:q)),oe((e=>e.length===y.length&&e.every(((e,t)=>e===y[t]))?e:y))}),[be,pe,q,U,B,H,V,K,Ee,s,t]);(0,r.useLayoutEffect)((()=>{Ce()}),[Ce]),(0,r.useEffect)((()=>{const e=X.current;if(!e)return;const t=()=>Ce();let n;return"undefined"!=typeof ResizeObserver?(n=new ResizeObserver(t),n.observe(e)):window.addEventListener("resize",t),()=>{n?n.disconnect():window.removeEventListener("resize",t)}}),[Ce]),(0,r.useEffect)((()=>{Ce()}),[pe,Ce]),(0,r.useLayoutEffect)((()=>{for(const e of te.current){if(!e)continue;const t=e.querySelector(".neko-tab-label");t&&e.classList.toggle("needs-fade",t.scrollWidth>t.clientWidth+1)}})),(0,r.useEffect)((()=>{if(!be.length)return;const e="string"==typeof P?P:pe;if(!ve.includes(e)&&ve.length>0){const t=be.find((e=>!e.hidden));t&&e!==t.key&&fe(t.key)}else e!==pe&&fe(e)}),[P,be,ve,pe]),(0,r.useEffect)((()=>{const e=be.find((e=>e.key===pe));if(e&&e.hidden){const e=be.find((e=>!e.hidden));e&&fe(e.key)}}),[be,pe]),(0,r.useLayoutEffect)((()=>{if(ge.current)return;if(!be.length)return;ge.current=!0;let e=pe;if(!e){var t;const n=$&&"undefined"!=typeof window?new URL(window.location.href).searchParams.get("nekoTab"):null;e=(n&&ve.includes(n)?n:null)||((null===(t=be.find((e=>!e.hidden)))||void 0===t?void 0:t.key)??ve[0]),fe(e)}if(L){const t=ve.indexOf(e);-1!==t&&be[t]&&xe(t,be[t])}}),[$,L,be,ve,pe,xe]);const Ae=(0,r.useMemo)((()=>o().Children.map(ye,((e,t)=>{const n=be[t];if(!n)return null;const r=n.key===pe&&!n.hidden;return o().cloneElement(e,{isActive:r,inversed:i,key:n.key,_panelId:`panel-${G}-${t}`,_labelledById:`tab-${G}-${t}`})}))),[ye,be,pe,i,G]),Me=(0,g.gR)("neko-tabs",{inversed:i});return o().createElement("div",y({className:Me},Y),t&&o().createElement(O,{className:`${i?"inversed":""} ${n?"has-subtitle":""}`},o().createElement(h.s,{h2:!0,className:"neko-tabs-title"},t),n&&o().createElement("div",{className:"neko-tabs-subtitle"},n)),o().createElement(C,null,o().createElement(A,{ref:X,role:"tablist","aria-label":Q},be.map(((e,t)=>{var n;const r=e.key===pe,a=(e.hidden||re.includes(t))&&!r,s=(null===(n=ye[t])||void 0===n?void 0:n.props)||{},u=s.busy||s.isBusy||!1,d=`neko-tab-title ${r?"active":""} ${e.requirePro?"disabled":""} ${a?"hidden":""} ${i?"inversed":""} `+(u?"busy":""),h=ne.current.widths[t]||H,p={...ce?{minWidth:B,maxWidth:W,flex:`1 1 ${h}px`}:{flex:"0 0 auto"},marginRight:de};return o().createElement(R,{key:e.key,id:`tab-${G}-${t}`,ref:e=>te.current[t]=e,role:"tab","aria-selected":r,"aria-controls":`panel-${G}-${t}`,"aria-disabled":e.requirePro||u?"true":"false",tabIndex:r?0:-1,onKeyDown:Se(t),onClick:n=>{u||xe(t,e,n)},className:d,style:p,disabled:!!e.requirePro,"data-key":e.key},e.icon&&o().createElement(c.z,{icon:e.icon,width:15,height:15,style:{marginRight:5},raw:!0}),o().createElement("div",{className:"neko-tab-label",title:e.title},e.title),o().createElement(l.K,{className:"inline",show:e.requirePro,style:{marginLeft:10,marginRight:-5,top:-1}}))})),s&&o().createElement("span",{ref:ee,style:{display:"inline-flex",alignItems:"center",marginLeft:de,flex:"0 0 auto"}},s)),o().createElement(M,{ref:Z},D&&o().createElement("div",{style:{display:"flex",alignItems:"center",marginRight:re.length>0?10:0}},D?F?o().createElement(p.B,{variant:"ai"},"AI Engine"):o().createElement("a",{href:"https://meowapps.com/ai-engine/",target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:"6px",padding:"4px 12px",borderRadius:"999px",backgroundColor:"#fee",color:"#c33",fontSize:"12px",textDecoration:"none",transition:"all 0.2s ease",cursor:"pointer",border:"1px solid #fcc"},onMouseEnter:e=>{e.currentTarget.style.backgroundColor="#fdd",e.currentTarget.style.color="#a22"},onMouseLeave:e=>{e.currentTarget.style.backgroundColor="#fee",e.currentTarget.style.color="#c33"}},o().createElement("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},o().createElement("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),o().createElement("polyline",{points:"7 10 12 15 17 10"}),o().createElement("line",{x1:"12",y1:"15",x2:"12",y2:"3"})),"AI Engine"):null),re.length>0&&o().createElement("div",{style:{display:"flex",alignItems:"center"}},o().createElement("span",{ref:J,role:"button",tabIndex:0,"aria-haspopup":"menu","aria-expanded":ie?"true":"false","aria-label":"More tabs",onClick:()=>ae((e=>!e)),onKeyDown:e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),ae((e=>!e)))},className:"neko-tabs-chevron "+(ie?"open":""),style:{display:"inline-flex",alignItems:"center",marginLeft:20,marginRight:5,cursor:"pointer",color:i?"var(--neko-white)":"var(--neko-gray-60)"}},o().createElement(f.A,{size:22})),o().createElement(u.G,{visible:ie,targetRef:J,onClose:()=>{ae(!1),le("")},matchWidth:!1},o().createElement(T,null,re.length>8&&o().createElement("div",{style:{padding:6}},o().createElement(d.A,{value:se,placeholder:"Search tabs...",onChange:e=>le(e)})),o().createElement(z,{role:"menu"},re.filter((e=>{var t;if(!se)return!0;return((null===(t=be[e])||void 0===t?void 0:t.title)||"").toLowerCase().includes(se.toLowerCase())})).map((e=>{var t,n;return o().createElement(j,{key:(null===(t=be[e])||void 0===t?void 0:t.key)||e,role:"menuitem",onClick:t=>{ae(!1),le(""),xe(e,be[e],t)},className:"neko-tab-overflow-item"},(null===(n=be[e])||void 0===n?void 0:n.title)||`Tab ${e+1}`)})))))))),Ae,o().createElement("style",{jsx:"true"},"\n        .neko-tab-panel-wrapper {\n          border-radius: 0 8px 8px 8px;\n          overflow: hidden;\n        }\n      "))},$=e=>{const{children:t,isActive:n=!1,busy:r=!1,isBusy:i=!1,inversed:a,_panelId:s,_labelledById:l,title:c,icon:u,requirePro:d,key:h,...p}=e,f=r||i;o().useEffect((()=>{i&&console.log('NekoTab: The "isBusy" prop is deprecated. Please use "busy" instead.')}),[i]);const y=(0,g.gR)("neko-tab-content",{active:n,inversed:a});return o().createElement(m.A,{busy:f,overlayStyle:{borderRadius:"0 8px 8px 8px"},className:"neko-tab-panel-wrapper"},o().createElement(P,{id:s,role:"tabpanel","aria-labelledby":l,"aria-hidden":n?"false":"true",hidden:!n,className:y},n&&t))},L=e=>o().createElement(N,e);L.propTypes={title:a().string,subtitle:a().string,isPro:a().bool,onChange:a().func,action:a().node,currentTab:a().string,keepTabOnReload:a().bool,callOnTabChangeFirst:a().bool,inversed:a().bool,mwaiPill:a().bool,mwaiEnabled:a().bool,minWidth:a().number,idealWidth:a().number,maxWidth:a().number,gap:a().number,minGap:a().number,chevronReserve:a().number,layoutBuffer:a().number,ariaLabel:a().string};const D=e=>o().createElement($,e);D.propTypes={isActive:a().bool,requirePro:a().bool,title:a().string,icon:a().string,busy:a().bool,isBusy:a().bool}},7494:(e,t,n)=>{"use strict";n.d(t,{V:()=>u});var r=n(1594),o=n.n(r),i=n(7639),a=n.n(i);function s(){return s=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},s.apply(this,arguments)}const l=n(3185).Ay.div`
  box-sizing: border-box;
  display: flex;
  width: 100%;
  padding: 10px 10px;
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Activity",[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2",key:"169zse"}]])},6632:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("ArrowUp",[["path",{d:"m5 12 7-7 7 7",key:"hav0vg"}],["path",{d:"M12 19V5",key:"x0mq9r"}]])},972:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]])},2640:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Bot",[["path",{d:"M12 8V4H8",key:"hb8ula"}],["rect",{width:"16",height:"12",x:"4",y:"8",rx:"2",key:"enze0r"}],["path",{d:"M2 14h2",key:"vft8re"}],["path",{d:"M20 14h2",key:"4cs60a"}],["path",{d:"M15 13v2",key:"1xurst"}],["path",{d:"M9 13v2",key:"rq6x2g"}]])},7073:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("CircleAlert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]])},1004:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Database",[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]])},1585:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Eraser",[["path",{d:"m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21",key:"182aya"}],["path",{d:"M22 21H7",key:"t4ddhn"}],["path",{d:"m5 11 9 9",key:"1mo9qw"}]])},827:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("FileText",[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]])},9612:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]])},9594:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Info",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 16v-4",key:"1dtifu"}],["path",{d:"M12 8h.01",key:"e9boi3"}]])},9798:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Maximize2",[["polyline",{points:"15 3 21 3 21 9",key:"mznyad"}],["polyline",{points:"9 21 3 21 3 15",key:"1avn1i"}],["line",{x1:"21",x2:"14",y1:"3",y2:"10",key:"ota7mn"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14",key:"1atl0r"}]])},7504:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("MessageSquare",[["path",{d:"M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z",key:"1lielz"}]])},8614:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Play",[["polygon",{points:"6 3 20 12 6 21 6 3",key:"1oa8hb"}]])},697:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]])},9492:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("RotateCcw",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}]])},8445:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Send",[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z",key:"1ffxy3"}],["path",{d:"m21.854 2.147-10.94 10.939",key:"12cjpa"}]])},6110:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Sparkles",[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z",key:"4pj2yx"}],["path",{d:"M20 3v4",key:"1olli1"}],["path",{d:"M22 5h-4",key:"1gvqau"}],["path",{d:"M4 17v2",key:"vumght"}],["path",{d:"M5 18H3",key:"zchphs"}]])},8834:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]])},4796:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const r=(0,n(9407).A)("Upload",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"17 8 12 3 7 8",key:"t8dd8p"}],["line",{x1:"12",x2:"12",y1:"3",y2:"15",key:"widbto"}]])},3893:(e,t,n)=>{"use strict";n.d(t,{A:()=>r});
/**
 * @license lucide-react v0.454.0 - ISC
 *
 * This source code is licensed under the ISC license.
